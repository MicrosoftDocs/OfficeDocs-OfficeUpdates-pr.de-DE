...
### <a name="excel"></a><span data-ttu-id="8d969-126">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-126">Excel</span></span>
...
### <a name="word"></a><span data-ttu-id="8d969-154">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-154">Word</span></span>
...
### <a name="word"></a><span data-ttu-id="8d969-227">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-227">Word</span></span>
...
### <a name="powerpoint"></a><span data-ttu-id="8d969-284">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-284">PowerPoint</span></span>
...
### <a name="onenote"></a><span data-ttu-id="8d969-301">OneNote</span><span class="sxs-lookup"><span data-stu-id="8d969-301">OneNote</span></span>
...
### <a name="powerpoint"></a><span data-ttu-id="8d969-328">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-328">PowerPoint</span></span>
...
### <a name="excel"></a><span data-ttu-id="8d969-342">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-342">Excel</span></span>
...
### <a name="project"></a><span data-ttu-id="8d969-382">Project</span><span class="sxs-lookup"><span data-stu-id="8d969-382">Project</span></span>
...
- <span data-ttu-id="8d969-420">Diese Änderung ist gegen Verzögerungen bei der Verarbeitung von Bildern mit fehlerhaften oder ungültigen Protokollinformationen gerichtet.</span><span class="sxs-lookup"><span data-stu-id="8d969-420">This change addresses delays when processing images with malformed or invalid protocol information.</span></span>
...
### <a name="word"></a><span data-ttu-id="8d969-435">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-435">Word</span></span>
...
### <a name="project"></a><span data-ttu-id="8d969-450">Project</span><span class="sxs-lookup"><span data-stu-id="8d969-450">Project</span></span>
...
- <span data-ttu-id="8d969-455">Es wurde ein Problem behoben, bei dem die Ausrichtung von Wörtern in einem Dokument durcheinandergebracht wird, wenn Sie nach dem Drucken mit Schnelldruck versuchen, den Text zu bearbeiten.</span><span class="sxs-lookup"><span data-stu-id="8d969-455">We fixed an issue in which the alignment of words in a document gets scrambled when tried to edit after printing using Quick Print.</span></span>
- <span data-ttu-id="8d969-456">Es wurde ein Problem beim Zusammenführen von zwei Dokumenten in ein Dokument behoben.</span><span class="sxs-lookup"><span data-stu-id="8d969-456">We fixed an issue when merging two documents into one document.</span></span>
- <span data-ttu-id="8d969-457">Es wurde ein Problem behoben, bei dem das Markieren von Überarbeitungen, die Formeln enthalten, beim Speichern der Datei zu einem Fehler führen konnte.</span><span class="sxs-lookup"><span data-stu-id="8d969-457">Fixed an issue where marking revisions involving equations could result in a failure when saving the file.</span></span>

[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)

## <a name="version-2003-march-06"></a><span data-ttu-id="8d969-459">Version 2003: 6. März</span><span class="sxs-lookup"><span data-stu-id="8d969-459">Version 2003: March 06</span></span>
<span data-ttu-id="8d969-460">*Version 2003 (Build 12624.20086)*</span><span class="sxs-lookup"><span data-stu-id="8d969-460">*Version 2003 (Build 12624.20086)*</span></span>

[//]: # (BUGDETAILS NICHT ENTFERNEN BEGINN INHALT)

### <a name="resolved-issues"></a><span data-ttu-id="8d969-462">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-462">Resolved issues</span></span>
### <a name="outlook"></a><span data-ttu-id="8d969-463">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-463">Outlook</span></span>

- <span data-ttu-id="8d969-464">Ein Problem wurde behoben, bei dem das Erstellen einer Regel mit Outlook Web App auf dem Exchange-Server nicht beibehalten werden konnte und zu einem Konflikt geführt hat.</span><span class="sxs-lookup"><span data-stu-id="8d969-464">Fixed an issue where creating a rule with Outlook Web Access did not persist to the Exchange server and resulted in a conflict.</span></span>
- <span data-ttu-id="8d969-465">Wurde ein Problem mit Outlook im dunklen Modus behoben, wird möglicherweise die Dropdownliste im Feld "Von:" nicht angezeigt.</span><span class="sxs-lookup"><span data-stu-id="8d969-465">Fixed an issue with Outlook in dark mode would not display the drop down list in the 'From:' field.</span></span>
- <span data-ttu-id="8d969-466">Behebt ein Problem, das bewirkt hat, dass Benutzer Dateien nicht über den Datei-Explorer ihrer E-Mail-Nachricht als Anlage hinzufügen konnten, wenn diese Datei in einer anderen Anwendung geöffnet war.</span><span class="sxs-lookup"><span data-stu-id="8d969-466">Addresses an issue that caused users to be unable to attach a file to their mail message via the file explorer when that file was open in another application.</span></span>

### <a name="powerpoint"></a><span data-ttu-id="8d969-467">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-467">PowerPoint</span></span>

- <span data-ttu-id="8d969-468">Ein Problem wurde behoben, bei dem die empfohlenen Miniaturansichten blinkten, wenn Sie mit der Maus auf die Miniaturansichten gingen.</span><span class="sxs-lookup"><span data-stu-id="8d969-468">Fixed an issue where the recommended thumbnails flash when hovering your mouse over the thumbnails.</span></span> <span data-ttu-id="8d969-469">In einigen Fällen kann dies dazu führen, dass PowerPoint abstürzt.</span><span class="sxs-lookup"><span data-stu-id="8d969-469">In some cases this could cause PowerPoint to crash.</span></span>

### <a name="word"></a><span data-ttu-id="8d969-470">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-470">Word</span></span>

- <span data-ttu-id="8d969-471">Es wurde ein Problem mit der compare-Funktion für Dokumente behoben, die für die Bearbeitung geschützt waren.</span><span class="sxs-lookup"><span data-stu-id="8d969-471">Fixed an issue with Compare feature for documents that were protected for editing.</span></span>

### <a name="office-suite"></a><span data-ttu-id="8d969-472">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-472">Office Suite</span></span>

- <span data-ttu-id="8d969-473">Behebt ein Problem mit Word/Excel/PowerPoint, bei dem der User-Principal-Name (UPN) nicht mehr die Groß-/Kleinschreibung beachtet, was zu weniger Fehlern beim Arbeiten mit Dateien in SharePoint führt.</span><span class="sxs-lookup"><span data-stu-id="8d969-473">Fixed an issue Word/Excel/PowerPoint where the User Principal Name (UPN) is no longer case sensitive resulting in less failures when working with files on SharePoint.</span></span>

- <span data-ttu-id="8d969-474">Behebt ein kosmetisches Problem, bei dem die Schaltfläche "OK" im Dialogfeld „Datei \ Optionen“ abgeblendet angezeigt, die Funktionalität aber nicht beeinträchtigt wurde.</span><span class="sxs-lookup"><span data-stu-id="8d969-474">Fixed a cosmetic issue where the 'OK' button on the File \ Options dialog was being displayed as grayed out but functionality was not impacted.</span></span>

[//]: # (BUGDETAILS NICHT AM INHALTSENDE ENTFERNEN)

[//]: # (FEATUREDETAILS CONTENT START NICHT ENTFERNEN)

## <a name="version-2003-february-28"></a><span data-ttu-id="8d969-477">Version 2003: 28. Februar</span><span class="sxs-lookup"><span data-stu-id="8d969-477">Version 2003: February 28</span></span>
<span data-ttu-id="8d969-478">*Version 2003 (Build 12619.20002)*</span><span class="sxs-lookup"><span data-stu-id="8d969-478">*Version 2003 (Build 12619.20002)*</span></span>

[//]: # (FEATUREDETAILS NICHT ENTFERNEN BEGINN INHALT)

### <a name="feature-updates"></a><span data-ttu-id="8d969-480">Featureupdates</span><span class="sxs-lookup"><span data-stu-id="8d969-480">Feature updates</span></span>
### <a name="outlook"></a><span data-ttu-id="8d969-481">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-481">Outlook</span></span>

- <span data-ttu-id="8d969-482">**Benachrichtigung Über Vorfall für IT-Administratoren:** Globale Administratoren von Microsoft 365-Mandanten und Administratoren von Office-Apps werden über Outlook und O365 Exchange-Vorfällen benachrichtigt, die sich auf Ihre Benutzer auswirken – mit einer neuen Benachrichtigung im rechten Seitenbereich in Outlook für Windows.</span><span class="sxs-lookup"><span data-stu-id="8d969-482">**Incident Notification for IT Admins:** Microsoft 365 tenant global administrators and Office Apps Administrators will be notified about Outlook and O365 Exchange incidents affecting their users with a new right-side panel notification in Outlook for Windows.</span></span>

### <a name="powerpoint"></a><span data-ttu-id="8d969-483">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-483">PowerPoint</span></span>

- <span data-ttu-id="8d969-484">**Verbesserte Freihand-Shape-Diagrammdarstellung:** Zeichnen Sie bessere Diagramme und lassen Sie diese in ein Office-Objekt umwandeln, das Sie bearbeiten können. [Weitere Informationen unter ](https://support.office.com/article/f304ef73-9514-450b-9bb9-28c6057020f2)</span><span class="sxs-lookup"><span data-stu-id="8d969-484">**Improved ink to shape diagramming experience:** Draw better diagrams and have it convert so office object you can manipulate [Learn more](https://support.office.com/article/f304ef73-9514-450b-9bb9-28c6057020f2)</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="8d969-487">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-487">Resolved issues</span></span>
### <a name="excel"></a><span data-ttu-id="8d969-488">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-488">Excel</span></span>

- <span data-ttu-id="8d969-489">Ein Problem wurde behoben, bei dem der Text in einem Datenschnitt in der Druckvorschau nicht ordnungsgemäß skaliert wurde.</span><span class="sxs-lookup"><span data-stu-id="8d969-489">Fixed an issue where text in a slicer isn't scaled properly in Print Preview.</span></span>

### <a name="outlook"></a><span data-ttu-id="8d969-490">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-490">Outlook</span></span>

- <span data-ttu-id="8d969-491">Behebt ein Problem, das dazu geführt hat, dass das „Datum der letzten Änderung“ in einer Datei beim Hinzufügen einer Anlage zu einer E-Mail oder beim Speichern einer Anlage aus einer E-Mail durch Ziehen und Ablegen (im Gegensatz zum Hinzufügen oder Speichern über ein Menü) aktualisiert wurde.</span><span class="sxs-lookup"><span data-stu-id="8d969-491">Addresses an issue that caused the "Last Modified" date on a file to be updated when adding an attachment to a mail or saving an attachment from a mail by dragging and dropping it (as opposed to via a menu).</span></span>

### <a name="word"></a><span data-ttu-id="8d969-492">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-492">Word</span></span>

- <span data-ttu-id="8d969-493">Behebt ein Problem, das dazu geführt hat, dass beim Navigieren über eine Kommentarkarte mit der Tabulatortaste der Fokus auf dem Bearbeitungsfeld für den Kommentar nicht angezeigt wurde.</span><span class="sxs-lookup"><span data-stu-id="8d969-493">Fixed an issue that when tabbing through a comment card, the focus on the comment edit box would not be visible.</span></span>

- <span data-ttu-id="8d969-494">Das Einfügen eines Steuerelements (beispielsweise eines Textinhaltssteuerelements) in eine Gleichung und das anschließende Speichern und Öffnen der Datei führte zu einem Fehler aufgrund nicht lesbaren Inhalts.</span><span class="sxs-lookup"><span data-stu-id="8d969-494">Inserting a control (such as a Text Content Control) in an equation then saving and opening the file results in an un-readable content error.</span></span>

- <span data-ttu-id="8d969-495">Ein Problem wurde behoben, aufgrund dessen das Speichern einer zuvor kennwortgeschützten Datei in einem Cloudspeicher nicht funktioniert hat.</span><span class="sxs-lookup"><span data-stu-id="8d969-495">Fixed an issue where saving a previously password protected file to a cloud storage would not work.</span></span>

### <a name="office-suite"></a><span data-ttu-id="8d969-496">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-496">Office Suite</span></span>

- <span data-ttu-id="8d969-497">Behebt ein Problem, das dazu geführt hat, dass beim Öffnen mehrerer Dokumente in Word/Excel/PowerPoint aus derselben SharePoint-Bibliothek lediglich das erste geöffnete Dokument auf Richtlinienkonformität gescannt wurde.</span><span class="sxs-lookup"><span data-stu-id="8d969-497">Fixes an issue when multiple documents are open in Word/Excel/PowerPoint from the same SharePoint library, only the first document opened will be scanned for Policy compliance.</span></span>

[//]: # (BUGDETAILS NICHT ENTFERNEN INHALTSWENDE)

## <a name="version-2003-february-21"></a><span data-ttu-id="8d969-499">Version 2003: 21. Februar</span><span class="sxs-lookup"><span data-stu-id="8d969-499">Version 2003: February 21</span></span>
<span data-ttu-id="8d969-500">*Version 2003 (Build 12615.20000)*</span><span class="sxs-lookup"><span data-stu-id="8d969-500">*Version 2003 (Build 12615.20000)*</span></span>

[//]: # (FEATUREDETAILS NICHT ENTFERNEN BEGINN INHALT)

### <a name="feature-updates"></a><span data-ttu-id="8d969-502">Featureupdates</span><span class="sxs-lookup"><span data-stu-id="8d969-502">Feature updates</span></span>
### <a name="office-suite"></a><span data-ttu-id="8d969-503">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-503">Office Suite</span></span>

- <span data-ttu-id="8d969-504">**Perfekte Farbe auswählen:** Verwenden Sie hexadezimale Farbcodes, um genau die Farbe auszuwählen, die Sie für Ihre Schriftart, die Texthervorhebung und mehr benötigen.</span><span class="sxs-lookup"><span data-stu-id="8d969-504">**Pick the perfect color:** Use hex color codes to choose exactly the color you want for your font, text highlight, and more.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="8d969-507">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-507">Resolved issues</span></span>

### <a name="excel"></a><span data-ttu-id="8d969-508">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-508">Excel</span></span>
- <span data-ttu-id="8d969-509">Es wurde ein Problem behoben, das möglicherweise beim Umbenennen von Pivot-Tabellenmaßen aufgetreten ist.</span><span class="sxs-lookup"><span data-stu-id="8d969-509">Fixed an issue that users may have experienced when renaming pivot table measures.</span></span>
- <span data-ttu-id="8d969-510">Es wurde ein Leistungsproblem behoben, das möglicherweise bei der Verwendung eines VBA-Makros zum Löschen des Inhalts eines Bereichs aufgetreten ist.</span><span class="sxs-lookup"><span data-stu-id="8d969-510">Fixed a performance issue that users may have experienced when using a VBA macro to clear the contents of a range.</span></span>
- <span data-ttu-id="8d969-511">Es wurde ein Problem behoben, das zum Blinken der Benutzeroberfläche führte, wenn Benutzer ein Makro ausführten, das mit dem Menüband interagierte.</span><span class="sxs-lookup"><span data-stu-id="8d969-511">Fixed an issue that caused the UI to flash when users executed a macro that interacted with the ribbon.</span></span>
- <span data-ttu-id="8d969-512">Es wurde ein Problem behoben, bei dem CSV-Dateien falsch geladen wurden, wenn das erste Wort in der Datei TABLE lautete.</span><span class="sxs-lookup"><span data-stu-id="8d969-512">Fixed an issue where CSV files were loaded incorrectly when the first word in the file was TABLE.</span></span>
- <span data-ttu-id="8d969-513">Es wurde ein Problem behoben, bei dem es zu Abstürzen kommen konnte, wenn Benutzer zwischen zwei Arbeitsmappen mit unterschiedlichen Zoomstufen wechselten.</span><span class="sxs-lookup"><span data-stu-id="8d969-513">Fixed an issue where users may have experienced crashes when switching between two workbooks that had different zoom levels.</span></span>

### <a name="outlook"></a><span data-ttu-id="8d969-514">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-514">Outlook</span></span>
- <span data-ttu-id="8d969-515">Es wurde ein Problem behoben, das dazu führte, dass Benutzer keine Nachrichten in öffentlichen Ordnern öffnen konnten, wenn Outlook über Nacht laufen gelassen wurde.</span><span class="sxs-lookup"><span data-stu-id="8d969-515">Addressed an issue that caused users to be unable to open public folder messages when Outlook was left running overnight.</span></span>
- <span data-ttu-id="8d969-516">Es wurde eine Racebedingung behoben, bei der die Schaltflächen "Zulassen" und "Verweigern" auf der Seite "Berechtigungen" während des Authentifizierungsworkflows beim Hinzufügen eines Google Mail-Kontos deaktiviert sind.</span><span class="sxs-lookup"><span data-stu-id="8d969-516">Fixed a race condition where the 'Allow' and 'Deny' buttons on the permissions page are disabled during the authentication workflow of adding a Gmail account.</span></span>
- <span data-ttu-id="8d969-517">Es wurde ein Problem behoben, das dazu führte, dass Outlook in einigen Szenarien unerwartet Protokollausgaben erzeugte, selbst wenn die Protokollierung ausgeschaltet war.</span><span class="sxs-lookup"><span data-stu-id="8d969-517">Addressed an issue that caused Outlook to unexpectedly generate logging output in some scenarios, even when logging was turned off.</span></span>

### <a name="word"></a><span data-ttu-id="8d969-518">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-518">Word</span></span>
- <span data-ttu-id="8d969-519">Es wurde ein Problem behoben, bei dem Kommentarkarten nicht immer hervorgehoben werden, wenn der Mauszeiger über die Kommentarkarte bewegt wird.</span><span class="sxs-lookup"><span data-stu-id="8d969-519">Fixed an issue where comment cards don't always get highlighted when a mouse pointer hovers over the comment card.</span></span>
- <span data-ttu-id="8d969-520">Während einer aktiven Sitzung zur gemeinsamen Dokumenterstellung kann das direkte Hinzufügen eines Bildes in eine Kommentarkarte dazu führen, dass ein Tag hinzugefügt wird.</span><span class="sxs-lookup"><span data-stu-id="8d969-520">During an active document co-authoring session, adding an image directly in to a comment card may result in the addition of a tag.</span></span> <span data-ttu-id="8d969-521">Das Problem wurde behoben.</span><span class="sxs-lookup"><span data-stu-id="8d969-521">This issue has been fixed.</span></span>

### <a name="office-suite"></a><span data-ttu-id="8d969-522">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-522">Office Suite</span></span>
- <span data-ttu-id="8d969-523">Beim Verwenden der Metadateneigenschaften MultiChoice/Verweis/Verwaltet mit Word/Excel/PowerPoint-Dokumenten und dem Speichern in einer SharePoint-Dokumentbibliothek waren diese Eigenschaften bisher auf 255 Zeichen beschränkt.</span><span class="sxs-lookup"><span data-stu-id="8d969-523">When using Multichoice/Lookup/Managed-metadata properties with Word/Excel/PowerPoint documents and saving to a SharePoint Document Library, these properties were previously limited to 255 characters.</span></span> <span data-ttu-id="8d969-524">Wenn diese Eigenschaften 255 Zeichen überschritten, konnten solche Dokumente nicht gespeichert werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-524">When these properties exceeded 255 characters, such documents could not be saved.</span></span> <span data-ttu-id="8d969-525">Mit dieser Änderung wurde dieser Grenzwert auf 2048 Zeichen erhöht.</span><span class="sxs-lookup"><span data-stu-id="8d969-525">With this change, this limit has been increased to 2048 characters.</span></span>

[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)

## <a name="version-2003-february-14"></a><span data-ttu-id="8d969-527">Version 2003: 14. Februar</span><span class="sxs-lookup"><span data-stu-id="8d969-527">Version 2003: February 14</span></span>
<span data-ttu-id="8d969-528">*Version 2003 (Build 12607.20000)*</span><span class="sxs-lookup"><span data-stu-id="8d969-528">*Version 2003 (Build 12607.20000)*</span></span>

[//]: # (FEATUREDETAILS NICHT ENTFERNEN BEGINN INHALT)

### <a name="feature-updates"></a><span data-ttu-id="8d969-530">Featureupdates</span><span class="sxs-lookup"><span data-stu-id="8d969-530">Feature updates</span></span>
### <a name="outlook"></a><span data-ttu-id="8d969-531">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-531">Outlook</span></span>

- <span data-ttu-id="8d969-532">**Neue Benutzeroberfläche für WLAN-Netzwerke mit Anmeldung:** Sind Sie schon einmal einem WLAN-Netzwerk beigetreten, mit dem Sie sich anmelden mussten?</span><span class="sxs-lookup"><span data-stu-id="8d969-532">**New experience for captive wifi networks:** Have you ever joined a wifi network that required a web page to sign in with?</span></span> <span data-ttu-id="8d969-533">Outlook erkennt dies jetzt und hilft Ihnen, eine Verbindung zu herstellen.</span><span class="sxs-lookup"><span data-stu-id="8d969-533">Outlook now detects this and helps you get connected.</span></span>

### <a name="word"></a><span data-ttu-id="8d969-534">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-534">Word</span></span>

- <span data-ttu-id="8d969-535">**Freihand-Editor in der Toolbox der Zeichentools finden:** Wählen Sie "Zeichnen" und dann den Freihand-Editor-Stift aus, um Ihr Dokument mit dem Finger oder einem digitalen Stift zu bearbeiten.</span><span class="sxs-lookup"><span data-stu-id="8d969-535">**Find Ink Editor in your drawing toolbox:** Select Draw and then choose the Ink Editor pen to edit your document with your finger or a digital pen.</span></span> [<span data-ttu-id="8d969-536">Weitere Informationen</span><span class="sxs-lookup"><span data-stu-id="8d969-536">Learn more</span></span>](https://support.office.com/article/7edbcf8e-0004-484d-9b62-501a31c23ee9)

### <a name="office-suite"></a><span data-ttu-id="8d969-537">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-537">Office Suite</span></span>

- <span data-ttu-id="8d969-538">**Übersichtlichere Statusleistensymbole:** Statusleistensymbole sind jetzt einfacher zu sehen.</span><span class="sxs-lookup"><span data-stu-id="8d969-538">**Clearer status bar icons:** Status bar icons are now easier to see</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="8d969-541">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-541">Resolved issues</span></span>
### <a name="outlook"></a><span data-ttu-id="8d969-542">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-542">Outlook</span></span>

- <span data-ttu-id="8d969-543">Ein Problem wurde behoben, durch das Benutzer den Zugriff auf das Dialogfeld "Frei/Gebucht-Optionen" der Kalenderberechtigungen verloren.</span><span class="sxs-lookup"><span data-stu-id="8d969-543">Addressed an issue that caused users to lose access to the "Free Busy Options" calendar permissions dialog.</span></span>

- <span data-ttu-id="8d969-544">Es wurde ein Problem behoben, das zur Warnung "Leider besteht ein Problem beim Öffnen dieses Elements" führen kann, wenn Sie bestimmte Besprechungsserien-Instanzen öffnen, die aus einer anderen Zeitzone gesendet wurden.</span><span class="sxs-lookup"><span data-stu-id="8d969-544">Fixed an issue that may result in the alert: "Sorry we're having trouble opening this item" when opening some recurring meeting instances sent from a different time zone.</span></span>

- <span data-ttu-id="8d969-545">Es wurde ein Problem behoben, durch das Benutzer eine MSG-Datei möglicherweise nicht mehr öffnen können, nachdem die eine Anlage aus dieser Nachricht durch Ziehen und Ablegen verschoben haben.</span><span class="sxs-lookup"><span data-stu-id="8d969-545">Addressed an issue that could cause users to be unable to reopen a .msg file after dragging and dropping an attachment from that message.</span></span>

- <span data-ttu-id="8d969-546">Ein Problem wurde behoben, bei dem der Dateiname nach dem Hochladen einer Dateianlage aus Outlook nach OneDrive möglicherweise geändert wird, wenn der Name der Anlage eine Klammer enthält.</span><span class="sxs-lookup"><span data-stu-id="8d969-546">Fixed an issue where after uploading a file attachment from Outlook to OneDrive could result in the file name being changed if the attachment's name contained parenthesis.</span></span>

### <a name="powerpoint"></a><span data-ttu-id="8d969-547">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-547">PowerPoint</span></span>

- <span data-ttu-id="8d969-548">Es wurde ein Problem behoben, das dazu führen kann, dass ein Dokument, das ein Excel-Diagramm enthält, nicht in PowerPoint oder Word gespeichert werden kann.</span><span class="sxs-lookup"><span data-stu-id="8d969-548">Fixed an issue that could result in a failure to save a document in PowerPoint or Word containing an Excel chart.</span></span>

### <a name="word"></a><span data-ttu-id="8d969-549">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-549">Word</span></span>

- <span data-ttu-id="8d969-550">Ein Problem wurde behoben, bei dem Bilder in Dokumenten beim Export in eine PDF-Datei transparent sind.</span><span class="sxs-lookup"><span data-stu-id="8d969-550">Fixed an issue where pictures in documents lose transparency when exported to PDF.</span></span>

[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)

## <a name="version-2002-february-07"></a><span data-ttu-id="8d969-552">Version 2002: 07. Februar</span><span class="sxs-lookup"><span data-stu-id="8d969-552">Version 2002: February 07</span></span>
<span data-ttu-id="8d969-553">*Version 2002 (Build 12527.20040)*</span><span class="sxs-lookup"><span data-stu-id="8d969-553">*Version 2002 (Build 12527.20040)*</span></span>

[//]: # (FEATUREDETAILS NICHT ENTFERNEN BEGINN INHALT)

### <a name="feature-updates"></a><span data-ttu-id="8d969-555">Featureupdates</span><span class="sxs-lookup"><span data-stu-id="8d969-555">Feature updates</span></span>
### <a name="access"></a><span data-ttu-id="8d969-556">Zugriff</span><span class="sxs-lookup"><span data-stu-id="8d969-556">Access</span></span>

- <span data-ttu-id="8d969-557">**Seien Sie beim Arbeiten im Abfrage-Designer, in der SQL-Ansicht und im Fenster „Beziehungen“ produktiver:** Klicken Sie zum Öffnen, Gestalten, Vergrößern oder Verkleinern und Ausblenden mit der rechten Maustaste auf die betreffende Tabelle.</span><span class="sxs-lookup"><span data-stu-id="8d969-557">**Be more productive working in Query Designer, SQL view, and the Relationships window:** Right-click a table to open, design, size, and hide it.</span></span> <span data-ttu-id="8d969-558">Suchen und Ersetzen von Text in der SQL-Ansicht.</span><span class="sxs-lookup"><span data-stu-id="8d969-558">Search and replace text in SQL View.</span></span> <span data-ttu-id="8d969-559">Auswählen mehrerer Tabellen im Fenster „Beziehungen“.</span><span class="sxs-lookup"><span data-stu-id="8d969-559">Select multiple tables in the Relationships window.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="8d969-562">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-562">Resolved issues</span></span>
### <a name="access"></a><span data-ttu-id="8d969-563">Access</span><span class="sxs-lookup"><span data-stu-id="8d969-563">Access</span></span>

- <span data-ttu-id="8d969-564">Dieses Update behebt ein Problem bei der Verwendung von ADODB.</span><span class="sxs-lookup"><span data-stu-id="8d969-564">This update fixes an issue where using an ADODB.</span></span> <span data-ttu-id="8d969-565">Das Recorder-Objekt im VB-Code meldet möglicherweise einen Fehler falsch.</span><span class="sxs-lookup"><span data-stu-id="8d969-565">Recorder object in VB code may incorrectly report an error.</span></span>

- <span data-ttu-id="8d969-566">Dieses Update behebt ein Problem, das dazu führen kann, dass Microsoft Access eine Identitätsspalte in einer verknüpften SQL-Server-Tabelle nicht identifiziert, was dazu führen kann, dass Zeilen fälschlicherweise als gelöscht gemeldet werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-566">This update fixes an issue that can cause Microsoft Access to fail to identify an Identity Column in a linked SQL Server table, which can cause rows to be reported as deleted incorrectly.</span></span>

### <a name="excel"></a><span data-ttu-id="8d969-567">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-567">Excel</span></span>

- <span data-ttu-id="8d969-568">Ein Problem wurde behoben, das dazu geführt hatte, dass Excel bei Verschieben von Text in Spalten mit dynamischen Pfeilern abgestürzt ist.</span><span class="sxs-lookup"><span data-stu-id="8d969-568">Fixed an issue where Excel would crash when using Text To Columns with dynamic arrays.</span></span>

### <a name="outlook"></a><span data-ttu-id="8d969-569">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-569">Outlook</span></span>

- <span data-ttu-id="8d969-570">Ein Problem wurde behoben, das dazu geführt hatte, dass beim Durchblättern des Kalanders in der Monatsansicht die vorangegangenen Kalenderereignisse nicht angezeigt wurden.</span><span class="sxs-lookup"><span data-stu-id="8d969-570">Fixed an issue where scrolling in calendar with month view, fails to show previous calendar events.</span></span>

- <span data-ttu-id="8d969-571">Behebt ein Problem, das dazu geführt hat, dass Benutzer beim Anzeigen von mehr als 30 Kalendern in einer Citrix-Umgebung einen Absturz erlebt haben.</span><span class="sxs-lookup"><span data-stu-id="8d969-571">Addresses an issue that caused users to experience a crash when viewing more than 30 calendars in a Citrix environment.</span></span>

### <a name="powerpoint"></a><span data-ttu-id="8d969-572">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-572">PowerPoint</span></span>

- <span data-ttu-id="8d969-573">Ein Problem wurde behoben, das dazu geführt hatte, dass PowerPoint nach dem Schließen einer Datei diese nicht sofort aus der Sammlung von Präsentationen entfernt hat, sofern Ereignisverarbeiter (event handlers) ausgeführt werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-573">Fixed an issue where after closing a file, PowerPoint does not immediately remove it from the Presentations collection if there are any event handlers running.</span></span> <span data-ttu-id="8d969-574">Dadurch war die Zahl der vom Objektmodell gemeldeten, geöffneten Präsentationen falsch und das Herunterfahren von PowerPoint wurde verhindert.</span><span class="sxs-lookup"><span data-stu-id="8d969-574">Hence the number of open presentations reported by the object model is incorrect, and shutdown of PowerPoint is prevented.</span></span>

- <span data-ttu-id="8d969-575">Ein Problem mit dem Textmarker wurde behoben: Weißer Text mit dunkleren Textmarkerfarben wurde Schwarz mit Graustufen gedruckt.</span><span class="sxs-lookup"><span data-stu-id="8d969-575">Fixed an issue with highlighter : White texts with dark highlighter colors are printed as black in Grayscale.</span></span>

### <a name="word"></a><span data-ttu-id="8d969-576">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-576">Word</span></span>

- <span data-ttu-id="8d969-577">Beim Aktualisieren eines Inhaltsverzeichnisses bzw. dem Blättern durch dieses wird manchmal möglicherweise ein grauer Bereich auf dem Dokument angezeigt.</span><span class="sxs-lookup"><span data-stu-id="8d969-577">Updating and scrolling through a table of contents may sometimes display a gray area over the document.</span></span>

- <span data-ttu-id="8d969-578">Ein Problem wurde behoben, bei dem die Entwurfsversion eines Stammkommentars bei der gemeinsamen Dokumenterstellung zeitweise nicht beibehalten wurde.</span><span class="sxs-lookup"><span data-stu-id="8d969-578">Fixed an issue where if a document is being coauthored, the draft version of a root comment may not be preserved.</span></span>

- <span data-ttu-id="8d969-579">Ein Problem wurde behoben, das dazu geführt hatte, dass beim Hin- und Herwechseln zwischen Kommentar-Karten manchmal der anfänglich ausgewählte Kommentar mit einer Auswahlhervorhebung angezeigt wurde.</span><span class="sxs-lookup"><span data-stu-id="8d969-579">Fixed an issue where going back and forth between comment cards would sometimes display the initially selected comment with a selection highlight.</span></span>

- <span data-ttu-id="8d969-580">Es wurde ein Problem mit der Verwendung von „Durchsuchen“ zum Speichern einer Datei behoben, das nicht funktioniert hat, wenn ein Kommentar geschrieben, jedoch nicht gepostet worden war und der Benutzer versucht hatte, die Datei zu speichern.</span><span class="sxs-lookup"><span data-stu-id="8d969-580">Fixed an issue where using 'Browse' to save a file did not work if a comment was written but not posted and the user tried to save the file.</span></span>

- <span data-ttu-id="8d969-581">Wenn „SlideTrack“ aktiviert und der Bereich „Kommentare“ geschlossen ist, kann der Bereich „Kommentare“ mit STRG+ALT+M möglicherweise nicht geöffnet werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-581">With SlideTrack enabled and the comments pane closed, Ctrl+Alt+M may not open the comments pane.</span></span>

- <span data-ttu-id="8d969-582">Es wurde ein Problem behoben, das dazu geführt hatte, dass beim Hinzufügen von @mention in einer Tabelle die Fehlermeldung „Eine Tabelle in diesem Dokument ist beschädigt“ generiert wurde.</span><span class="sxs-lookup"><span data-stu-id="8d969-582">Fixed an issue when adding @mention in a table could generate the error message: 'A table in this document has become corrupted'.</span></span>

### <a name="office-suite"></a><span data-ttu-id="8d969-583">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-583">Office Suite</span></span>

- <span data-ttu-id="8d969-584">Behebt ein Problem, das dazu geführt hat, dass Korrekturhilfe-Paket Norwegen Nynorsk (nn-no) nicht ordnungsgemäß installiert wurde.</span><span class="sxs-lookup"><span data-stu-id="8d969-584">Resolves an issue that may have caused Norway Nynorsk (nn-no) proofing tools package to be installed incorrectly.</span></span>

[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)


<span data-ttu-id="8d969-586">[FR. 5/29/2020]-die Seite "Insider fast" wird abgeschnitten, indem der folgende Inhalt gelöscht wird.</span><span class="sxs-lookup"><span data-stu-id="8d969-586">[Fri 5/29/2020] - Trimmed Insider Fast page by deleting the following content.</span></span>

## <a name="version-2002-january-31"></a><span data-ttu-id="8d969-587">Version 2002: 31. Januar</span><span class="sxs-lookup"><span data-stu-id="8d969-587">Version 2002: January 31</span></span>
<span data-ttu-id="8d969-588">*Version 2002 (Build 12513.20010)*</span><span class="sxs-lookup"><span data-stu-id="8d969-588">*Version 2002 (Build 12513.20010)*</span></span>
 
[//]: # (FEATUREDETAILS NICHT ENTFERNEN BEGINN INHALT)
 
### <a name="feature-updates"></a><span data-ttu-id="8d969-590">Featureupdates</span><span class="sxs-lookup"><span data-stu-id="8d969-590">Feature updates</span></span>
### <a name="excel"></a><span data-ttu-id="8d969-591">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-591">Excel</span></span>
 
- <span data-ttu-id="8d969-592">**Schnell lesen und antworten:** Antworten Sie auf Kommentare und Erwähnungen direkt aus dem E-Mail-Bereich, ohne die Arbeitsmappe zu öffnen.</span><span class="sxs-lookup"><span data-stu-id="8d969-592">**Read and reply on the fly:** Respond to comments and mentions right from email without opening the workbook.</span></span>
 
- <span data-ttu-id="8d969-593">**Datenprofilerstellung im Abfrage-Editor:** Sie können die Daten in Ihren Spalten auf einen Blick analysieren, Fehler- und Leerwerte identifizieren, Verteilungshistogramme anzeigen und vieles mehr.</span><span class="sxs-lookup"><span data-stu-id="8d969-593">**Data Profiling in Query Editor:** Get-a-glance analysis of the data in your columns, identify error and empty values, see distribution histograms and more.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="8d969-596">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-596">Resolved issues</span></span>
### <a name="outlook"></a><span data-ttu-id="8d969-597">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-597">Outlook</span></span>
 
- <span data-ttu-id="8d969-598">Problem behoben, bei dem für auf Grundlage einer Aufbewahrungsrichtlinie ablaufende E-Mails zwei Beschriftungen angezeigt wurden.</span><span class="sxs-lookup"><span data-stu-id="8d969-598">Fixed an issue where emails expiring based on a retention policy would display two labels.</span></span> <span data-ttu-id="8d969-599">Eine mit der Aussage, dass die E-Mail in einem Tag, die andere, dass die E-Mail in zwei Tagen abläuft.</span><span class="sxs-lookup"><span data-stu-id="8d969-599">One showing that the mail will expire in one day and another displaying that it will expire in two days.</span></span>
 
### <a name="word"></a><span data-ttu-id="8d969-600">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-600">Word</span></span>
 
- <span data-ttu-id="8d969-601">Problem behoben, bei dem ein Kommentarhinweis bei &quot;inverser&quot; Seitenfarbe nicht sichtbar war.</span><span class="sxs-lookup"><span data-stu-id="8d969-601">Fixed an issue where comment hint was not visible in read mode with &quot;Inverse&quot; page color.</span></span>
 
- <span data-ttu-id="8d969-602">Problem behoben, bei dem kursive Formatierung nach dem Bearbeiten eines Kommentars, kursiver Formatierung des Texts und anschließendem Posten verloren wurde.</span><span class="sxs-lookup"><span data-stu-id="8d969-602">Fixed an issue where italics formatting is lost after editing a comment, italicizing the text and then posting it.</span></span>
 
- <span data-ttu-id="8d969-603">Problem behoben, bei dem Kommentarbefehle (Kommentar bearbeiten, auf Kommentar antworten, Kommentar löschen, Kommentar auflösen) nicht im Kontextmenü von Kommentaren angezeigt wurden.</span><span class="sxs-lookup"><span data-stu-id="8d969-603">Fixed an issue where comment commands (Edit comment, Reply to comment, Delete comment, Resolve comment) in the comments context menu were not being displayed.</span></span>
 
[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)
 
## <a name="version-2002-january-17"></a><span data-ttu-id="8d969-605">Version 2002: 17. Januar</span><span class="sxs-lookup"><span data-stu-id="8d969-605">Version 2002: January 17</span></span>
<span data-ttu-id="8d969-606">*Version 2002 (Build 12508.20000)*</span><span class="sxs-lookup"><span data-stu-id="8d969-606">*Version 2002 (Build 12508.20000)*</span></span>
 
[//]: # (FEATUREDETAILS NICHT ENTFERNEN BEGINN INHALT)
 
### <a name="feature-updates"></a><span data-ttu-id="8d969-608">Featureupdates</span><span class="sxs-lookup"><span data-stu-id="8d969-608">Feature updates</span></span>
### <a name="word"></a><span data-ttu-id="8d969-609">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-609">Word</span></span>
 
- <span data-ttu-id="8d969-610">**Benachrichtigungs-E-Mails für Erwähnungen und Kommentare enthalten jetzt eine Vorschau:** E-Mail-Benachrichtigungen für Erwähnungen und Kommentare enthalten jetzt eine Vorschau des Kommentartexts und des Kontexts, auf den verwiesen wird.</span><span class="sxs-lookup"><span data-stu-id="8d969-610">**Mention & comment notification emails now contain previews:** Email notifications for mentions & comments will now include previews of the comment text and context for what it is referring to.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="8d969-613">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-613">Resolved issues</span></span>
### <a name="excel"></a><span data-ttu-id="8d969-614">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-614">Excel</span></span>
 
- <span data-ttu-id="8d969-615">In einigen Fällen wurden von der Barrierefreiheitsprüfung keine Empfehlungen für Formen angezeigt.</span><span class="sxs-lookup"><span data-stu-id="8d969-615">In some cases, the Accessibility checker would not show the recommendations for shapes.</span></span>
 
### <a name="outlook"></a><span data-ttu-id="8d969-616">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-616">Outlook</span></span>
 
- <span data-ttu-id="8d969-617">Ordner, die unter "Favoriten" im linken Navigationsbereich gespeichert sind, können zeitweise verschwinden.</span><span class="sxs-lookup"><span data-stu-id="8d969-617">Folders saved in 'Favorites' in the left navigation pane may intermittently disappear.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="8d969-618">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-618">PowerPoint</span></span>
 
- <span data-ttu-id="8d969-619">Ein Problem wurde behoben, bei dem Freihandelemente in einer PowerPoint-Freihandanimation nicht vollständig gerendert wurde oder übersprungen wurde.</span><span class="sxs-lookup"><span data-stu-id="8d969-619">Fixed an issue where Ink may not render completely or get skipped when used in a PowerPoint ink animations.</span></span>
 
[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)
 
## <a name="version-2001-january-10"></a><span data-ttu-id="8d969-621">Version 2001: 10. Januar</span><span class="sxs-lookup"><span data-stu-id="8d969-621">Version 2001: January 10</span></span>
<span data-ttu-id="8d969-622">*Version 2001 (Build 12430.20000)*</span><span class="sxs-lookup"><span data-stu-id="8d969-622">*Version 2001 (Build 12430.20000)*</span></span>
 
[//]: # (FEATUREDETAILS NICHT ENTFERNEN BEGINN INHALT)
 
### <a name="feature-updates"></a><span data-ttu-id="8d969-624">Featureupdates</span><span class="sxs-lookup"><span data-stu-id="8d969-624">Feature updates</span></span>
### <a name="excel"></a><span data-ttu-id="8d969-625">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-625">Excel</span></span>
- <span data-ttu-id="8d969-626">**Speichern von Shapes als Bildern:** mit nur wenigen Mausklicks können Sie eine Form, ein Symbol oder ein anderes Objekt als Bilddatei speichern, um Sie an anderer Stelle wiederzuverwenden.</span><span class="sxs-lookup"><span data-stu-id="8d969-626">**Save shapes as pictures:** In just a few clicks, save a shape, icon, or other object as a picture file so you can reuse it elsewhere.</span></span> [<span data-ttu-id="8d969-627">Weitere Informationen</span><span class="sxs-lookup"><span data-stu-id="8d969-627">Learn more</span></span>](https://support.office.com/article/3c4f9ca4-945a-4c33-af91-d10e4e3ea715)
 
### <a name="outlook"></a><span data-ttu-id="8d969-628">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-628">Outlook</span></span>
- <span data-ttu-id="8d969-629">**Der Benutzer kann nun Objekte in Word/Excel/Outlook als Bild für Windows speichern.:** Diese Möglichkeit ist bereits aus PowerPoint bekannt, sodass Benutzer nun Objekte in Word, Excel und Outlook als Bild speichern können.</span><span class="sxs-lookup"><span data-stu-id="8d969-629">**User can now save objects in Word/Excel/Outlook as a picture for Windows.:** With the ability already seen in PowerPoint, users can now save objects in Word, Excel and Outlook as a picture.</span></span> <span data-ttu-id="8d969-630">Zu den Objekten gehören Formen, Symbole, Bilder und vieles mehr!</span><span class="sxs-lookup"><span data-stu-id="8d969-630">Objects include shapes, icons, pictures, and more!</span></span> <span data-ttu-id="8d969-631">Sie können über das Kontextmenü darauf zugreifen.</span><span class="sxs-lookup"><span data-stu-id="8d969-631">This can be accessed through the right-click menu.</span></span>
 
### <a name="word"></a><span data-ttu-id="8d969-632">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-632">Word</span></span>
- <span data-ttu-id="8d969-633">**Wählen Sie auf einfache Weise Freihand in Word aus, indem Sie eine Form um das Freihandobjekt zeichnen.:** das Lassotool auf der Registerkarte „Zeichnen“ hilft Ihnen beim Auswählen von frei handgezeichneten Objekten.</span><span class="sxs-lookup"><span data-stu-id="8d969-633">**Easily select ink in Word by drawing a shape around it.:** The Lasso tool on the Draw tab helps you select objects drawn with ink.</span></span> <span data-ttu-id="8d969-634">Wählen Sie einzelne Striche oder ganze Wörter aus.</span><span class="sxs-lookup"><span data-stu-id="8d969-634">Select individual strokes, or whole words.</span></span> <span data-ttu-id="8d969-635">Das ist praktisch, wenn Sie eine viele Freihandobjekte haben und nur mit einigen davon arbeiten möchten.</span><span class="sxs-lookup"><span data-stu-id="8d969-635">It's handy when you have lots of ink and you only want to work with some of it.</span></span> [<span data-ttu-id="8d969-636">Weitere Informationen</span><span class="sxs-lookup"><span data-stu-id="8d969-636">Learn more</span></span>](https://support.office.com/article/6d76c674-7f4b-414d-b67f-b3ffef6ccf53)
 
- <span data-ttu-id="8d969-637">**Speichern von Shapes als Bildern:** mit nur wenigen Mausklicks können Sie eine Form, ein Symbol oder ein anderes Objekt als Bilddatei speichern, um Sie an anderer Stelle wiederzuverwenden.</span><span class="sxs-lookup"><span data-stu-id="8d969-637">**Save shapes as pictures:** In just a few clicks, save a shape, icon, or other object as a picture file so you can reuse it elsewhere.</span></span> [<span data-ttu-id="8d969-638">Weitere Informationen</span><span class="sxs-lookup"><span data-stu-id="8d969-638">Learn more</span></span>](https://support.office.com/article/3c4f9ca4-945a-4c33-af91-d10e4e3ea715)
...
### <a name="resolved-issues"></a><span data-ttu-id="8d969-641">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-641">Resolved issues</span></span>
### <a name="onenote"></a><span data-ttu-id="8d969-642">OneNote</span><span class="sxs-lookup"><span data-stu-id="8d969-642">OneNote</span></span>
- <span data-ttu-id="8d969-643">Seitenregisterkarten werden bei einer Auflösung von 100% möglicherweise zu klein und zu nah aneinander angezeigt.</span><span class="sxs-lookup"><span data-stu-id="8d969-643">Page tabs may appear too small and close together at 100% resolution.</span></span>
 
### <a name="word"></a><span data-ttu-id="8d969-644">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-644">Word</span></span>
- <span data-ttu-id="8d969-645">Bei einer großen Gruppe von Kommentaren kann das Löschen eines Kommentars am Ende der Kommentarliste dazu führen, dass der Bereich ganz nach oben gescrollt wird.</span><span class="sxs-lookup"><span data-stu-id="8d969-645">In a large set of comments, deleting a comment near the end of the list of comments may result in the pane scrolling all the way to the top.</span></span>
 
[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)
 
## <a name="version-2001-january-03"></a><span data-ttu-id="8d969-647">Version 2001: 03. Januar</span><span class="sxs-lookup"><span data-stu-id="8d969-647">Version 2001: January 03</span></span>
<span data-ttu-id="8d969-648">*Version 2001 (Build 12425.20000)*</span><span class="sxs-lookup"><span data-stu-id="8d969-648">*Version 2001 (Build 12425.20000)*</span></span>
 
[//]: # (BUGDETAILS NICHT ENTFERNEN BEGINN INHALT)
 
### <a name="resolved-issues"></a><span data-ttu-id="8d969-650">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-650">Resolved issues</span></span>
 
### <a name="excel"></a><span data-ttu-id="8d969-651">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-651">Excel</span></span>
- <span data-ttu-id="8d969-652">Einige Rahmenlinien werden auf Papier im Format A4 möglicherweise nicht wie erwartet gedruckt.</span><span class="sxs-lookup"><span data-stu-id="8d969-652">Some border lines may not print as expected on A4 size paper.</span></span>
- <span data-ttu-id="8d969-653">Das Einfügen eines Bildes in die Kopf-/Fußzeile eines Diagrammobjekts auf einem Blatt mit VBA kann zu einem Fehler führen.</span><span class="sxs-lookup"><span data-stu-id="8d969-653">Adding an image to the header/footer of a chart object on a sheet using VBA may result in an error.</span></span>
- <span data-ttu-id="8d969-654">Beim Formatieren einer Diagrammachse ist der Abstand zwischen den Beschriftungen auf 255 Zeichen begrenzt.</span><span class="sxs-lookup"><span data-stu-id="8d969-654">When formatting a chart axis, the interval between labels was limited to 255.</span></span>
- <span data-ttu-id="8d969-655">Ein Problem wurde behoben, bei dem beim Versuch, eine XML-Abfrage zu aktualisieren, deren URL zur Datenquelle abgeschnitten wurde, ein Fehler auftrat.</span><span class="sxs-lookup"><span data-stu-id="8d969-655">Fixed an issue where an error would occur trying to refresh an XML query in which the URL to the datasource was being truncated.</span></span>
- <span data-ttu-id="8d969-656">In der Arbeitsmappenstatistik wird eine Makroanzahl aus allen geöffneten Arbeitsmappen angezeigt, einschließlich der persönlichen Makroarbeitsmappe.</span><span class="sxs-lookup"><span data-stu-id="8d969-656">Workbook Statistics would report a macro count from all open workbooks, including the personal macro workbook.</span></span>
 
### <a name="outlook"></a><span data-ttu-id="8d969-657">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-657">Outlook</span></span>
- <span data-ttu-id="8d969-658">Das Wechseln von Ordnern kann zu einem kurzen weißen "Blitz" in der E-Mail-Liste/E-Mail-Vorschau führen.</span><span class="sxs-lookup"><span data-stu-id="8d969-658">Switching folders may result in a brief white 'flash' in the mail list / mail preview.</span></span> <span data-ttu-id="8d969-659">Dieses Verhalten war im dunklen Modus ausgeprägter.</span><span class="sxs-lookup"><span data-stu-id="8d969-659">This behavior was more pronounced in dark mode.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="8d969-660">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-660">PowerPoint</span></span>
- <span data-ttu-id="8d969-661">Ein Problem mit dem Objektmodell wurde behoben, bei dem das Aufrufen der Methode "Shape.Paste" dazu führte, dass die eingefügte Form den Fokus erhielt.&nbsp;</span><span class="sxs-lookup"><span data-stu-id="8d969-661">Fixed an Object Model issue where calling Shape.Paste method would result in the pasted shape receiving focus.&nbsp;</span></span>
- <span data-ttu-id="8d969-662">Verbessertes Kopieren-Einfügen-Szenario:&nbsp; Das programmgesteuerte Kopieren einer Form aus einer PowerPoint-Folie und das Einfügen dieser Form in eine andere Folie in einer Schleife konnte mit einem Ausnahmefehler fehlschlagen.&nbsp;</span><span class="sxs-lookup"><span data-stu-id="8d969-662">Improved a copy-paste scenario:&nbsp;Progamatically copying a shape from a PowerPoint slide and pasting it to another slide in a loop could fail with an exception error.&nbsp;</span></span>
- <span data-ttu-id="8d969-663">Animationen in den Abschnittsüberschriften von Folien wurden nach dem Reduzieren und Erweitern von Abschnittsüberschriften nicht korrekt gerendert.</span><span class="sxs-lookup"><span data-stu-id="8d969-663">Animation in the section headers of slides would not render properly after collapsing and expanding section headers.</span></span>
 
### <a name="project"></a><span data-ttu-id="8d969-664">Project</span><span class="sxs-lookup"><span data-stu-id="8d969-664">Project</span></span>
- <span data-ttu-id="8d969-665">Ein Problem wurde behoben, bei dem der Textumbruch in der Task- und Ressourcennutzungsansicht nicht funktionierte.</span><span class="sxs-lookup"><span data-stu-id="8d969-665">Fixed an issue where text wrapping wasn't working in the task and resource usage views.</span></span>
- <span data-ttu-id="8d969-666">Ein Problem wurde behoben, bei dem der Kostenwert bei Aufgaben möglicherweise nicht korrekt ist, wenn eine Ressource mehrere Kostensätze aufweist.</span><span class="sxs-lookup"><span data-stu-id="8d969-666">Fixed an issue where if a resource has more than one cost rate, cost value on assignments may not be correct.</span></span>
 
### <a name="word"></a><span data-ttu-id="8d969-667">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-667">Word</span></span>
- <span data-ttu-id="8d969-668">Das Einfügen eines Steuerelements (z. B. eines Textinhaltssteuerelements) in eine Gleichung und das anschließende Speichern und Öffnen der Datei führte zu einem Fehler aufgrund nicht lesbaren Inhalts.</span><span class="sxs-lookup"><span data-stu-id="8d969-668">Inserting a control (such as a Text Content Control) in an equation, then saving and opening the file would result in an un-readable content error.</span></span>
- <span data-ttu-id="8d969-669">Bei der gemeinsamen Dokumenterstellung wird ein Kommentar, der mit Word Online hinzugefügt wurde, auf dem Word-Desktop möglicherweise nicht angezeigt.</span><span class="sxs-lookup"><span data-stu-id="8d969-669">When co-authoring, adding a comment using Word online may not appear in Word desktop.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="8d969-670">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-670">Office Suite</span></span>
- <span data-ttu-id="8d969-671">Die Anzeige eines falschen Ablaufdatums der gültigen Lizenz beim Versuch, eine Einzellizenz zu ändern, wurde entfernt.</span><span class="sxs-lookup"><span data-stu-id="8d969-671">Removed showing an erroneous expiry date of the valid license when trying to change license with only one license.</span></span>
 
[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)
 
## <a name="version-2001-december-13"></a><span data-ttu-id="8d969-673">Version 2001: 13. Dezember</span><span class="sxs-lookup"><span data-stu-id="8d969-673">Version 2001: December 13</span></span>
<span data-ttu-id="8d969-674">*Version 2001 (Build 12410.20000)*</span><span class="sxs-lookup"><span data-stu-id="8d969-674">*Version 2001 (Build 12410.20000)*</span></span>
 
[//]: # (FEATUREDETAILS NICHT ENTFERNEN BEGINN INHALT)
 
### <a name="feature-updates"></a><span data-ttu-id="8d969-676">Featureupdates</span><span class="sxs-lookup"><span data-stu-id="8d969-676">Feature updates</span></span>
### <a name="outlook"></a><span data-ttu-id="8d969-677">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-677">Outlook</span></span>
 
- <span data-ttu-id="8d969-678">**Ziehen Sie E-Mails in eine Gruppe, die Sie besitzen:** Verschieben und Kopieren von Nachrichten und Unterhaltungen, indem Sie diese aus Ihrem Posteingang ziehen.</span><span class="sxs-lookup"><span data-stu-id="8d969-678">**Drag email to a group you own:** Move and copy messages and conversations by dragging them from your inbox.</span></span> <span data-ttu-id="8d969-679">Die von ihnen gezogenen Nachrichten werden für alle Gruppenmitglieder freigegeben.</span><span class="sxs-lookup"><span data-stu-id="8d969-679">Messages you drag will be shared with all group members.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="8d969-682">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-682">Resolved issues</span></span>
### <a name="access"></a><span data-ttu-id="8d969-683">Access</span><span class="sxs-lookup"><span data-stu-id="8d969-683">Access</span></span>
- <span data-ttu-id="8d969-684">Das Ausführen einer Verbundabfrage, die auf verknüpfte ODBC-Tabellen verweist und eine ORDER BY-Klausel enthält, stürzt den 64-Bit-Zugriff ab.</span><span class="sxs-lookup"><span data-stu-id="8d969-684">Executing a union query that references linked ODBC table(s) and contains an Order By clause crashes 64 bit Access.</span></span>
- <span data-ttu-id="8d969-685">Das Summieren von Daten aus Verbundsabfragen in Access (O365) kann zu einer Verkürzung der dezimalen Daten führen.</span><span class="sxs-lookup"><span data-stu-id="8d969-685">Summing of data from union queries in Access (O365) may result in truncation of decimal data.</span></span>
- <span data-ttu-id="8d969-686">COM-Schnittstellen für ACE werden nicht für den Einsatz außerhalb von Office-Anwendungen freigegeben.</span><span class="sxs-lookup"><span data-stu-id="8d969-686">COM Interfaces for ACE are not exposed for use outside of Office applications.</span></span>
 
### <a name="excel"></a><span data-ttu-id="8d969-687">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-687">Excel</span></span>
- <span data-ttu-id="8d969-688">Das Einfügen eines 3D-Modells (animiert oder statisch) und der Versuch, als Bild zu speichern, funktioniert nicht.</span><span class="sxs-lookup"><span data-stu-id="8d969-688">Inserting a 3D model (animated or static) and trying to 'Save as Picture' doesn't work.</span></span>
- <span data-ttu-id="8d969-689">Die Kurztaste (Alt + Strg + 7/8), um Feedback aus dem Backstage-Bereich zu starten, steht im Konflikt mit QWERTZ-Tastaturen (AltGr + 7/8).</span><span class="sxs-lookup"><span data-stu-id="8d969-689">The shortkey (Alt+Ctrl + 7/8)  to launch feedback from backstage is in conflict with AZERTY keyboards (Alt-Gr + 7/8).</span></span> <span data-ttu-id="8d969-690">Auswirkung: Benutzer sind möglicherweise nicht in der Lage, einige Zeichen wie: '\' zu verwenden.</span><span class="sxs-lookup"><span data-stu-id="8d969-690">Impact: users may not be able to use some characters such as: '\'.</span></span>
 
### <a name="outlook"></a><span data-ttu-id="8d969-691">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-691">Outlook</span></span>
- <span data-ttu-id="8d969-692">Behebt ein Problem, bei dem E-Mails an die für den Empfänger falsche Adresse gesendet wurden.</span><span class="sxs-lookup"><span data-stu-id="8d969-692">Addresses an issue that caused email to be sent to the wrong address for the recipient.</span></span>
- <span data-ttu-id="8d969-693">Behebt ein Problem, das dazu führte, dass Outlook-Benutzern mit &quot;Lesezugriff&quot; auf ein Postfach fälschlicherweise erlaubte, den gelesenen/ungelesenen Status einer Nachricht zu ändern.</span><span class="sxs-lookup"><span data-stu-id="8d969-693">Addresses an issue that caused Outlook to incorrectly allow users with &quot;read&quot; access to a mailbox to change the read/unread state of a message.</span></span>
- <span data-ttu-id="8d969-694">Der Widerruf des Sicherheitszertifikats auf der Website ist für den Produkt Support nicht reproduzierbar.</span><span class="sxs-lookup"><span data-stu-id="8d969-694">The revocation of the security certificate on the web site is not re-producible by Product Support.</span></span> <span data-ttu-id="8d969-695">Die Protokollierung muss hinzugefügt werden, um die Ursache für das Problem zu beheben.</span><span class="sxs-lookup"><span data-stu-id="8d969-695">Logging needs to be added to help root cause the issue.</span></span>
- <span data-ttu-id="8d969-696">Behebt ein Problem, bei dem Benutzer Synchronisationsfehler festgestellt haben.</span><span class="sxs-lookup"><span data-stu-id="8d969-696">Addresses an issue that caused users to see synchronization failures.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="8d969-697">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-697">PowerPoint</span></span>
- <span data-ttu-id="8d969-698">Das Einfügen eines 3D-Modells (animiert oder statisch) und der Versuch, als Bild zu speichern, funktioniert nicht.</span><span class="sxs-lookup"><span data-stu-id="8d969-698">Inserting a 3D model (animated or static) and trying to 'Save as Picture' doesn't work.</span></span>
 
### <a name="project"></a><span data-ttu-id="8d969-699">Project</span><span class="sxs-lookup"><span data-stu-id="8d969-699">Project</span></span>
- <span data-ttu-id="8d969-700">Die Aufgabenarbeit wird im Summenrollup für manuell geplante Unteraufgaben nicht berechnet.</span><span class="sxs-lookup"><span data-stu-id="8d969-700">Task work is not calculated in Summary roll-up for manually scheduled child tasks.</span></span>
- <span data-ttu-id="8d969-701">Projekt-VBA-Code, der von einer Multifunktionsleiste aufgerufen wird, funktioniert möglicherweise nicht, wenn versucht wird, serverbasierte Projekte zu speichern.</span><span class="sxs-lookup"><span data-stu-id="8d969-701">Project VBA Code invoked from a Ribbon button may not work when trying to save server-based Projects.</span></span>
- <span data-ttu-id="8d969-702">Wenn Project nicht bereits ausgeführt wird, zeigt das Öffnen von Projektdateien aus einer SharePoint-Dokumentbibliothek einen Fehler an und die Datei wird nicht geöffnet.</span><span class="sxs-lookup"><span data-stu-id="8d969-702">Unless Project is already running, opening Project files from a SharePoint document library displays an error and the file will not open.</span></span>
 
### <a name="word"></a><span data-ttu-id="8d969-703">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-703">Word</span></span>
- <span data-ttu-id="8d969-704">Das Speichern vorhandener Dateien funktioniert möglicherweise nicht.</span><span class="sxs-lookup"><span data-stu-id="8d969-704">Saving existing files may not work.</span></span>
- <span data-ttu-id="8d969-705">Die Verwendung der Pfeiltasten im Fenster des Editors für Rechtschreibung und Grammatik kann zu intermittierendem Flackern führen.</span><span class="sxs-lookup"><span data-stu-id="8d969-705">Using arrow keys in the Spelling and Grammar editor window may result in intermittent flickering.</span></span>
- <span data-ttu-id="8d969-706">Bei der Behebung einer Nachverfolgung können zugehörige Kommentare nicht in Punktkommentare umgewandelt werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-706">When resolving a follow-up, associated comments may not convert to point comments.</span></span>
- <span data-ttu-id="8d969-707">Das Einfügen eines 3D-Modells (animiert oder statisch) und der Versuch, als Bild zu speichern, funktioniert nicht.</span><span class="sxs-lookup"><span data-stu-id="8d969-707">Inserting a 3D model (animated or static) and trying to 'Save as Picture' doesn't work.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="8d969-708">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-708">Office Suite</span></span>
- <span data-ttu-id="8d969-709">Es wurde ein Problem behoben, bei dem Office-Update-Nachrichten in einer anderen Sprache als erwartet angezeigt wurden.</span><span class="sxs-lookup"><span data-stu-id="8d969-709">Fixed an issue where Office update messages appear in a different language than expected.</span></span> <span data-ttu-id="8d969-710">In Zukunft entsprechen Office-Update-Nachrichten ordnungsgemäß der Windows-Anzeigesprache.</span><span class="sxs-lookup"><span data-stu-id="8d969-710">Going forward, Office update messages will correctly match the Windows display language.</span></span>
 
[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)
 
## <a name="version-1912-december-06"></a><span data-ttu-id="8d969-712">Version 1912: 6. Dezember</span><span class="sxs-lookup"><span data-stu-id="8d969-712">Version 1912: December 06</span></span>
<span data-ttu-id="8d969-713">*Version 1912 (Build 12325.20012)*</span><span class="sxs-lookup"><span data-stu-id="8d969-713">*Version 1912 (Build 12325.20012)*</span></span>
 
[//]: # (FEATUREDETAILS NICHT ENTFERNEN BEGINN INHALT)
 
### <a name="feature-updates"></a><span data-ttu-id="8d969-715">Featureupdates</span><span class="sxs-lookup"><span data-stu-id="8d969-715">Feature updates</span></span>
### <a name="outlook"></a><span data-ttu-id="8d969-716">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-716">Outlook</span></span>
 
- <span data-ttu-id="8d969-717">**Erweiterte Gruppen-E-Mail-Einstellungen:** Diese Funktion hilft Gruppenbenutzern dabei, die E-Mails oder Ereignisse anzupassen, die sie in ihrem Posteingang empfangen/verfolgen möchten.</span><span class="sxs-lookup"><span data-stu-id="8d969-717">**Advanced group email settings:** This feature helps groups users to customize which emails or events to receive/follow in their inbox.</span></span>
 
- <span data-ttu-id="8d969-718">**Benennungsrichtlinie für Gruppen:** Mit einer Benennungsrichtlinie für Gruppen kann der IT-Administrator die Namen von Gruppen, die von Benutzern in der Organisation erstellt wurden, standardisieren und verwalten.</span><span class="sxs-lookup"><span data-stu-id="8d969-718">**Groups Naming policy:** A group naming policy enables the IT admin to standardize and manage the names of groups created by users in the organization.</span></span> <span data-ttu-id="8d969-719">Der Administrator kann festlegen, dass dem Namen einer Gruppe beim Erstellen ein bestimmtes Präfixes und ein Suffix hinzugefügt werden, und er kann bestimmte Wörter blockieren.</span><span class="sxs-lookup"><span data-stu-id="8d969-719">The admin can require a specific prefix and suffix be added to the name for a group when it's created, and can block specific words from being used.</span></span> <span data-ttu-id="8d969-720">Auf diese Weise kann die Verwendung von unpassenden Wörtern in Gruppennamen minimiert und die Darstellung von Gruppen in Ihrem Verzeichnis verwaltet werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-720">This helps minimize the use of inappropriate words in group names as well as IT manage the representation of groups in their directory.</span></span> <span data-ttu-id="8d969-721">Die Benennungsrichtlinie hilft außerdem Organisationen, die Teamwebsites bereitstellen, um diese je nach Abteilung zu kategorisieren.</span><span class="sxs-lookup"><span data-stu-id="8d969-721">Naming Policy also helps organizations that deploy team sites to categorize them based on department.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="8d969-722">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-722">Office Suite</span></span>
 
- <span data-ttu-id="8d969-723">**Bereiche im Registerkartenformat:** Jetzt können Sie über die Registerkarten-Benutzeroberfläche auf der rechten Seite der App zwischen mehreren Bereichen wechseln.</span><span class="sxs-lookup"><span data-stu-id="8d969-723">**Tabbed Panes:** Now you can switch between multiple panes using a tab UI on the right hand side of the app.</span></span> <span data-ttu-id="8d969-724">Die Benutzeroberfläche wird nur angezeigt, wenn Sie mehr als 2 Fenster geöffnet haben.</span><span class="sxs-lookup"><span data-stu-id="8d969-724">The UI will only be visible when you have 2+ panes open.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="8d969-727">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-727">Resolved issues</span></span>
### <a name="excel"></a><span data-ttu-id="8d969-728">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-728">Excel</span></span>
- <span data-ttu-id="8d969-729">Beim Speichern von Änderungen bei der Verwendung einiger nicht englischer Zeichengruppen tritt möglicherweise ein Fehler auf.</span><span class="sxs-lookup"><span data-stu-id="8d969-729">Users may encounter an error when saving changes while using some non-English character sets.</span></span>
- <span data-ttu-id="8d969-730">Beim Zugriff auf einen verborgenen benannten Bereich kann ein Fehler auftreten.</span><span class="sxs-lookup"><span data-stu-id="8d969-730">Users may encounter an error when accessing a hidden named range.</span></span>
- <span data-ttu-id="8d969-731">Das Deaktivieren der Beschleunigung von Hardware-Grafiken mit 4K könnte die Wiedergabe von Zellen verzögern.</span><span class="sxs-lookup"><span data-stu-id="8d969-731">Disabling hardware graphics acceleration with 4K resolution may result in delayed rendering of cells when scrolling around.</span></span>
- <span data-ttu-id="8d969-732">Das Löschen einer langen Formel, die eine Zellbegrenzung überlappt, wird möglicherweise weiterhin über die Zellbegrenzung angezeigt.</span><span class="sxs-lookup"><span data-stu-id="8d969-732">Clearing a long formula that overlaps a cell boundary may still display across the cell boundary.</span></span>
- <span data-ttu-id="8d969-733">Es wurde ein Problem behoben, bei dem die Anpassung des Menübands beim Öffnen einer eingebetteten Arbeitsmappe nicht geladen wurde.</span><span class="sxs-lookup"><span data-stu-id="8d969-733">Resolved an issue with ribbon customization not loading when opening embedded workbook.</span></span>
- <span data-ttu-id="8d969-734">Dropdownmenü „Rand“ wird möglicherweise nicht ordnungsgemäß gerendert.</span><span class="sxs-lookup"><span data-stu-id="8d969-734">Margin dropdown menu may not render correctly.</span></span>
 
### <a name="onenote"></a><span data-ttu-id="8d969-735">OneNote</span><span class="sxs-lookup"><span data-stu-id="8d969-735">OneNote</span></span>
- <span data-ttu-id="8d969-736">Möglicherweise wird OneNote nicht über das Outlook-Add-in „Besprechungsnotizen“ geöffnet.</span><span class="sxs-lookup"><span data-stu-id="8d969-736">OneNote may not open via the 'Meeting Notes' Outlook add-in.</span></span>
 
### <a name="outlook"></a><span data-ttu-id="8d969-737">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-737">Outlook</span></span>
- <span data-ttu-id="8d969-738">Bei Aufbewahrungsrichtlinien für Bezeichnungen kann der Aufbewahrungszeitraum in Klammern anzeigt sein.</span><span class="sxs-lookup"><span data-stu-id="8d969-738">Retention policy labels may display the retention time period in parenthesis.</span></span>
- <span data-ttu-id="8d969-739">Auf Visitenkarten mit dem japanischem Sprachpaket können Leerzeichen angezeigt werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-739">Blank spaces may appear in Contact cards with Japanese language pack.</span></span>
- <span data-ttu-id="8d969-740">Bilder, die in Outlook-E-Mail-Nachrichten Inline eingefügt wurden, können manchmal geändert werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-740">Images inserted inline to Outlook e-mail messages can sometimes get resized.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="8d969-741">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-741">PowerPoint</span></span>
- <span data-ttu-id="8d969-742">Wenn ein Benutzer zwei (oder mehr) verschiedene Videos auf einer Folie in einer Cloud-Datei hat, werden die Videobilder korrekt wiedergegeben, aber wenn der Benutzer zum Abspielen auf jedes einzelne klickt, ist der Videoinhalt derselbe.</span><span class="sxs-lookup"><span data-stu-id="8d969-742">If a user has two (or more) different videos on a slide in a cloud file, the video images are rendered correctly, but when the user clicks on each one to play, the video content is the same.</span></span>
- <span data-ttu-id="8d969-743">In einigen Fällen geht Scrollen bei Touchscreen-Geräten nicht.</span><span class="sxs-lookup"><span data-stu-id="8d969-743">In some cases, scrolling with touch devices will not work.</span></span>
- <span data-ttu-id="8d969-744">Dropdownmenü „Rand“ wird möglicherweise nicht ordnungsgemäß gerendert.</span><span class="sxs-lookup"><span data-stu-id="8d969-744">Margin dropdown menu may not render correctly.</span></span>
- <span data-ttu-id="8d969-745">Safelinks aus einer Office-Anwendung zu einer anderen können die verknüpfte Anwendung nicht starten.</span><span class="sxs-lookup"><span data-stu-id="8d969-745">Safelinks from one Office application to another may not launch the linked application.</span></span>
 
### <a name="project"></a><span data-ttu-id="8d969-746">Project</span><span class="sxs-lookup"><span data-stu-id="8d969-746">Project</span></span>
- <span data-ttu-id="8d969-747">Project stürzt ab, wenn Sie die Funktion „Projekte vergleichen“ verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="8d969-747">Project may crash when you use the Compare Projects feature.</span></span>
- <span data-ttu-id="8d969-748">Wenn Sie sich im dunklen Modus befinden, können Sie die Tabelle nicht lesen, wenn Sie zu einem Vorgang mit einer überlasteten Ressource im Vorgangsinspektor wechseln.</span><span class="sxs-lookup"><span data-stu-id="8d969-748">If you are in Dark mode, when you go to the task inspector panel on a task with an over allocated resource, you are unable to read the table.</span></span>
- <span data-ttu-id="8d969-749">Das Festlegen von Aufwand für Vorgänge, die keine Aufgaben haben, wird auf 1 Tag abgerundet.</span><span class="sxs-lookup"><span data-stu-id="8d969-749">Setting effort on tasks that have no assignments are rounded to 1 day.</span></span>
 
### <a name="word"></a><span data-ttu-id="8d969-750">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-750">Word</span></span>
- <span data-ttu-id="8d969-751">Das Speichern einer Datei nach einem Seriendruck funktioniert unter bestimmten Bedingungen möglicherweise nicht.</span><span class="sxs-lookup"><span data-stu-id="8d969-751">Saving a file after doing a mail merge may not work under certain conditions.</span></span>
- <span data-ttu-id="8d969-752">Im Organizer für Bausteine könnte eine ungültige Warnung angezeigt werden: &quot;Sie haben modifizierte Formen, Bausteine&quot;.</span><span class="sxs-lookup"><span data-stu-id="8d969-752">Building blocks organizer may display an invalid alert: &quot;You have modified styles, building blocks&quot;.</span></span>
- <span data-ttu-id="8d969-753">Der Kommentarbereich wird manchmal beim Kopieren/Einfügen neu geladen.</span><span class="sxs-lookup"><span data-stu-id="8d969-753">Comment pane sometimes gets reloaded when using copy/paste.</span></span>
- <span data-ttu-id="8d969-754">Kommentare werden manchmal nicht in der richtigen Reihenfolge eingefügt.</span><span class="sxs-lookup"><span data-stu-id="8d969-754">Comments are sometimes not pasted in the correct order.</span></span>
- <span data-ttu-id="8d969-755">Das Anwenden einer Vorlage, die aus einer mehrstufigen Liste mit benutzerdefinierten Formatvorlagen besteht, auf bestehende Dokumente kann unter bestimmten Bedingungen die Formatvorlage nicht beibehalten.</span><span class="sxs-lookup"><span data-stu-id="8d969-755">Applying a template consisting of a multi-level list with custom styles to existing documents may not preserve the style under certain conditions.</span></span>
- <span data-ttu-id="8d969-756">Wenn Sie die Größe eines geteilten Bildschirms ändern, wird ggf. ein weiterer geteilter Bildschirm öffnen.</span><span class="sxs-lookup"><span data-stu-id="8d969-756">Resizing a split screen border may introduce an additional split screen.</span></span>
- <span data-ttu-id="8d969-757">Dropdownmenü „Rand“ wird möglicherweise nicht ordnungsgemäß gerendert.</span><span class="sxs-lookup"><span data-stu-id="8d969-757">Margin dropdown menu may not render correctly.</span></span>
- <span data-ttu-id="8d969-758">Wenn ein Benutzer auf einer Kommentarkarte erwähnt wird, wird möglicherweise JSON angezeigt.</span><span class="sxs-lookup"><span data-stu-id="8d969-758">At-mentioning a user in a comment card may show JSON.</span></span>
- <span data-ttu-id="8d969-759">Safelinks aus einer Office-Anwendung zu einer anderen können die verknüpfte Anwendung nicht starten.</span><span class="sxs-lookup"><span data-stu-id="8d969-759">Safelinks from one Office application to another may not launch the linked application.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="8d969-760">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-760">Office Suite</span></span>
- <span data-ttu-id="8d969-761">Bei Produkten mit einer Formatierung für Japan wird der Nachname des Benutzerkontos in der falschen Reihenfolge angezeigt.</span><span class="sxs-lookup"><span data-stu-id="8d969-761">For Japanese based products, account user first name, last name may appear in incorrect order.</span></span>
- <span data-ttu-id="8d969-762">Beim Bewegen des Mauszeigers über Kommentare wird möglicherweise eine TextBox-Kontur um den Kommentar angezeigt.</span><span class="sxs-lookup"><span data-stu-id="8d969-762">Hovering a mouse pointer over comments may display a textbox outline around the comment.</span></span>
 
[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)
 
## <a name="version-1912-november-15"></a><span data-ttu-id="8d969-764">Version 1912: 15. November</span><span class="sxs-lookup"><span data-stu-id="8d969-764">Version 1912: November 15</span></span>
<span data-ttu-id="8d969-765">*Version 1912 (Build 12307.20000)*</span><span class="sxs-lookup"><span data-stu-id="8d969-765">*Version 1912 (Build 12307.20000)*</span></span>
 
[//]: # (FEATUREDETAILS NICHT ENTFERNEN BEGINN INHALT)
 
### <a name="feature-updates"></a><span data-ttu-id="8d969-767">Featureupdates</span><span class="sxs-lookup"><span data-stu-id="8d969-767">Feature updates</span></span>
### <a name="insights-services"></a><span data-ttu-id="8d969-768">Insights-Services</span><span class="sxs-lookup"><span data-stu-id="8d969-768">Insights Services</span></span>
- <span data-ttu-id="8d969-769">**Abfragen in natürlicher Sprache in "Excel-Ideen":** Die neue Funktion von "Excel-Ideen", mit der Sie eine Frage zu Ihren Daten in natürlicher Sprache stellen können.</span><span class="sxs-lookup"><span data-stu-id="8d969-769">**Natural Language Queries in Ideas in Excel:** Excel Ideas's new capability to ask a natural language question about your data.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="8d969-772">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-772">Resolved issues</span></span>
### <a name="excel"></a><span data-ttu-id="8d969-773">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-773">Excel</span></span>
- <span data-ttu-id="8d969-774">Die Funktion "Text in Spalte" könnte bei einigen Lokalisierungen nicht funktionieren.</span><span class="sxs-lookup"><span data-stu-id="8d969-774">Text to Column functionality may fail for some localizations.</span></span>
- <span data-ttu-id="8d969-775">Beim Bearbeiten von dynamischen Arrayformeln innerhalb einer Zelle könnte Text außerhalb der Begrenzung der Zelle ausgerichtet werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-775">Editing dynamic array formulas within a cell may result in text being aligned outside of the boundary of the cell.</span></span>
 
### <a name="outlook"></a><span data-ttu-id="8d969-776">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-776">Outlook</span></span>
- <span data-ttu-id="8d969-777">Es wurde die Möglichkeit des Erzwingens der S/MIME-Konfiguration über eine Gruppenrichtlinie hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="8d969-777">Added the ability to enforce S/MIME configuration via group policy.</span></span>
- <span data-ttu-id="8d969-778">Eingebettete Bilder könnten kleiner als erwartet erscheinen.</span><span class="sxs-lookup"><span data-stu-id="8d969-778">Embedded images may appear smaller than expected.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="8d969-779">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-779">PowerPoint</span></span>
- <span data-ttu-id="8d969-780">Der Cursor verschwindet möglicherweise nach dem Verschieben des Fokus von einem Textinhalt.</span><span class="sxs-lookup"><span data-stu-id="8d969-780">Cursor may disappear after moving focus from text.</span></span>
 
### <a name="project"></a><span data-ttu-id="8d969-781">Project</span><span class="sxs-lookup"><span data-stu-id="8d969-781">Project</span></span>
- <span data-ttu-id="8d969-782">Es könnte ein Fehler hinsichtlich der Lizenzierung auftreten.</span><span class="sxs-lookup"><span data-stu-id="8d969-782">Users may experience an error regarding licensing.</span></span>
- <span data-ttu-id="8d969-783">Die Schaltfläche "Heute" in der Datumsauswahl könnte ein falsches Datum festlegen.</span><span class="sxs-lookup"><span data-stu-id="8d969-783">The Today button in the date picker may sometimes set the incorrect date.</span></span>
 
### <a name="word"></a><span data-ttu-id="8d969-784">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-784">Word</span></span>
- <span data-ttu-id="8d969-785">Bei einem Rechtsklick könnte manchmal nicht das ganze Wort markiert werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-785">Right-clicking can sometimes not result in selecting the whole word.</span></span>
- <span data-ttu-id="8d969-786">Nach der Konvertierung in ein vorgeschlagenes Format bleibt der Cursor u. U. in einem Objekt aktiv.</span><span class="sxs-lookup"><span data-stu-id="8d969-786">The cursor may remain active within an object after converting to a suggested format.</span></span>
- <span data-ttu-id="8d969-787">In einigen Szenarien werden Bilder in Nachrichten u. U. nicht ordnungsgemäß skaliert.</span><span class="sxs-lookup"><span data-stu-id="8d969-787">Images in messages may be incorrectly scaled in some scenarios.</span></span>
- <span data-ttu-id="8d969-788">Einige Designs erschweren es möglicherweise, den ausgewählten Kommentar zu erkennen.</span><span class="sxs-lookup"><span data-stu-id="8d969-788">Some themes may make it difficult to determine which comment is selected.</span></span>
- <span data-ttu-id="8d969-789">Beim Auswählen eines Kommentarhinweises im Bereich "Ansicht wechseln" sollte jetzt der moderne Kommentarbereich angezeigt werden, wenn dieser verborgen war.</span><span class="sxs-lookup"><span data-stu-id="8d969-789">Selecting a comment hint should now show the modern comments pane when hidden in pane switcher.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="8d969-790">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-790">Office Suite</span></span>
- <span data-ttu-id="8d969-791">Das Antworten auf einen Kommentar könnte dazu führen, dass das Textfeld vertikal über den Rand des Bereichs hinaus erweitert wird.</span><span class="sxs-lookup"><span data-stu-id="8d969-791">Replying to a comment may cause the textbox to expand vertically beyond the edge of the pane.</span></span>
 
[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)
 
## <a name="version-1912-november-08"></a><span data-ttu-id="8d969-793">Version 1912: 8. November</span><span class="sxs-lookup"><span data-stu-id="8d969-793">Version 1912: November 08</span></span>
<span data-ttu-id="8d969-794">*Version 1912 (Build 12231.20000)*</span><span class="sxs-lookup"><span data-stu-id="8d969-794">*Version 1912 (Build 12231.20000)*</span></span>
 
[//]: # (FEATUREDETAILS NICHT ENTFERNEN BEGINN INHALT)
 
### <a name="feature-updates"></a><span data-ttu-id="8d969-796">Featureupdates</span><span class="sxs-lookup"><span data-stu-id="8d969-796">Feature updates</span></span>
### <a name="user-lifecycle"></a><span data-ttu-id="8d969-797">Lebenszyklus des Benutzers:</span><span class="sxs-lookup"><span data-stu-id="8d969-797">User Lifecycle</span></span>
- <span data-ttu-id="8d969-798">**Verbesserungen bei der AFO-Aktivierung:** Aktualisierungen der Bildschirme, die den Kunden beim Aktivieren der im Lieferumfang Ihres neuen PCs enthaltenen Office-Version angezeigt werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-798">**Experience improvements for AFO activation:** Updates to the screens customers see when activating Office that comes bundled with their new PC.</span></span>
 
### <a name="word"></a><span data-ttu-id="8d969-799">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-799">Word</span></span>
- <span data-ttu-id="8d969-800">**Neue und verbesserte Online-Videofunktionen in Word:** Neue und sicherere Onlinevideoerfahrung, die Ihnen beim Einfügen neuer Videos und beim Abspielen vorhandener Videos in Word hilft.</span><span class="sxs-lookup"><span data-stu-id="8d969-800">**New and improved online video experience in Word:** New and more secure online video experience to help you insert new videos and play existing videos in Word.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="8d969-803">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-803">Resolved issues</span></span>
### <a name="outlook"></a><span data-ttu-id="8d969-804">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-804">Outlook</span></span>
- <span data-ttu-id="8d969-805">Zeitweiliger Absturz bei ordnerübergreifenden Inhalten.</span><span class="sxs-lookup"><span data-stu-id="8d969-805">Intermittent crash involving cross folder content.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="8d969-806">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-806">Office Suite</span></span>
- <span data-ttu-id="8d969-807">Wenn Sie ein Diagramm aus Excel in PowerPoint einfügen, kann sich die Größe des Diagramms verringern.</span><span class="sxs-lookup"><span data-stu-id="8d969-807">Pasting a chart from Excel to PowerPoint can reduce the size of the chart.</span></span>
 
[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)
 
## <a name="version-1911-november-01"></a><span data-ttu-id="8d969-809">Version 1911: 1. November</span><span class="sxs-lookup"><span data-stu-id="8d969-809">Version 1911: November 01</span></span>
<span data-ttu-id="8d969-810">*Version 1911 (Build 12228.20020)*</span><span class="sxs-lookup"><span data-stu-id="8d969-810">*Version 1911 (Build 12228.20020)*</span></span>
 
[//]: # (FEATUREDETAILS NICHT ENTFERNEN BEGINN INHALT)
 
### <a name="feature-updates"></a><span data-ttu-id="8d969-812">Featureupdates</span><span class="sxs-lookup"><span data-stu-id="8d969-812">Feature updates</span></span>
### <a name="excel"></a><span data-ttu-id="8d969-813">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-813">Excel</span></span>
- <span data-ttu-id="8d969-814">**Nehmen Sie den Kontext mit ihren SVG-Objekten mit!:** Sie können jetzt den Text in Karten, Diagrammen und anderen SVG-Vektoren beibehalten, wenn Sie diese Objekte in Office konvertieren.</span><span class="sxs-lookup"><span data-stu-id="8d969-814">**Bring the context along with your SVG objects!:** Now you can retain the text in maps, chart and other SVG vectors when converting these objects in Office.</span></span>
 
- <span data-ttu-id="8d969-815">**Sehen Sie sich die Stiftoptionen an, wenn Sie Ihren Surface Pen aufnehmen:** Wenn Sie Ihren Surface Pen in Word, Excel oder PowerPoint in die Hand nehmen, wird die Registerkarte „Zeichnen“ aktiviert, damit Sie ganz einfach die Stiftfarben auswählen können.</span><span class="sxs-lookup"><span data-stu-id="8d969-815">**See Your Pen Options When You Pick Up Your Surface Pen:** When you first pick up your Surface Pen in Word, Excel, or PowerPoint, the Draw tab will be activated to make selecting your pen colors easy.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="8d969-816">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-816">PowerPoint</span></span>
- <span data-ttu-id="8d969-817">**Nehmen Sie den Kontext mit ihren SVG-Objekten mit!:** Sie können jetzt den Text in Karten, Diagrammen und anderen SVG-Vektoren beibehalten, wenn Sie diese Objekte in Office konvertieren.</span><span class="sxs-lookup"><span data-stu-id="8d969-817">**Bring the context along with your SVG objects!:** Now you can retain the text in maps, chart and other SVG vectors when converting these objects in Office.</span></span>
 
- <span data-ttu-id="8d969-818">**Sehen Sie sich die Stiftoptionen an, wenn Sie Ihren Surface Pen aufnehmen:** Wenn Sie Ihren Surface Pen in Word, Excel oder PowerPoint in die Hand nehmen, wird die Registerkarte „Zeichnen“ aktiviert, damit Sie ganz einfach die Stiftfarben auswählen können.</span><span class="sxs-lookup"><span data-stu-id="8d969-818">**See Your Pen Options When You Pick Up Your Surface Pen:** When you first pick up your Surface Pen in Word, Excel, or PowerPoint, the Draw tab will be activated to make selecting your pen colors easy.</span></span>
 
### <a name="visio"></a><span data-ttu-id="8d969-819">Visio</span><span class="sxs-lookup"><span data-stu-id="8d969-819">Visio</span></span>
- <span data-ttu-id="8d969-820">**Erstellen von ansprechenden Visio-Diagrammen in Excel:** Visualisieren Sie Ihre Daten schnell und einfach in ansprechenden Visio-Diagrammen in Excel.</span><span class="sxs-lookup"><span data-stu-id="8d969-820">**Make polished Visio diagrams in Excel:** Quickly and easily visualize your data into polished Visio diagrams within Excel.</span></span> <span data-ttu-id="8d969-821">[Weitere Informationen](https://support.office.com/article/bee3b5aa-aaaf-4401-acc6-276b711c763c).</span><span class="sxs-lookup"><span data-stu-id="8d969-821">[Learn more](https://support.office.com/article/bee3b5aa-aaaf-4401-acc6-276b711c763c).</span></span>
 
### <a name="word"></a><span data-ttu-id="8d969-822">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-822">Word</span></span>
- <span data-ttu-id="8d969-823">**Sehen Sie sich die Stiftoptionen an, wenn Sie Ihren Surface Pen aufnehmen:** Wenn Sie Ihren Surface Pen in Word, Excel oder PowerPoint in die Hand nehmen, wird die Registerkarte „Zeichnen“ aktiviert, damit Sie ganz einfach die Stiftfarben auswählen können.</span><span class="sxs-lookup"><span data-stu-id="8d969-823">**See Your Pen Options When You Pick Up Your Surface Pen:** When you first pick up your Surface Pen in Word, Excel, or PowerPoint, the Draw tab will be activated to make selecting your pen colors easy.</span></span>
 
- <span data-ttu-id="8d969-824">**Verbesserungen bei der gemeinsamen Dokumenterstellung:** Die gemeinsame Dokumenterstellung wurde verbessert, indem Inhaltsänderungen den anderen Benutzern nun nahezu immer in Echtzeit angezeigt werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-824">**Coauthoring improvements:** Improved the coauthoring experience by making it more likely that content changes will be received by others in real time.</span></span>
 
- <span data-ttu-id="8d969-825">**Andere sehen Ihre Änderungen schnell:** Verbesserungen bei der gemeinsamen Dokumenterstellung bewirken, dass Ihre Mitarbeiter Ihre Änderungen noch schneller erkennen können als früher.</span><span class="sxs-lookup"><span data-stu-id="8d969-825">**Others see your changes quickly:** Co-authoring improvements mean your collaborators can see your changes faster than ever before.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="8d969-828">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-828">Resolved issues</span></span>
### <a name="excel"></a><span data-ttu-id="8d969-829">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-829">Excel</span></span>
- <span data-ttu-id="8d969-830">Es wurde ein Problem behoben, durch das die Bearbeitung einer geschützten Datei von einer nicht vertrauenswürdigen Netzwerkfreigabe zum Absturz von Excel geführt haben könnte.</span><span class="sxs-lookup"><span data-stu-id="8d969-830">Resolved an issue where Excel may crash when editing a protected file from an untrusted network share.</span></span>
- <span data-ttu-id="8d969-831">Es wurde ein Problem behoben, bei dem das Löschen von Blättern mit Sparklines, die auf Daten auf einem anderen Arbeitsblatt verweisen, dazu führen könnte, dass die Datei beim erneuten Öffnen als fehlerhaft identifiziert wird.</span><span class="sxs-lookup"><span data-stu-id="8d969-831">Resolved an issue where deleting sheets containing sparklines referencing data on another sheet could cause the file to be identified as corrupted when re-opened.</span></span>
- <span data-ttu-id="8d969-832">Es wurde ein Problem behoben, bei dem Sie beim Konvertieren von Berichtsfiltern zusammen mit der restlichen PivotTable für Abfragen an tabellarische SQL-Server möglicherweise falsche Ergebnisse erhalten.</span><span class="sxs-lookup"><span data-stu-id="8d969-832">Resolved an Issue where you may get incorrect results when converting report filters along with the rest of the PivotTable for queries to SQL tabular servers.</span></span>
- <span data-ttu-id="8d969-833">Die gleichzeitige Verwendung der Sprachausgabe und der Bildschirmlupe kann zu einem Absturz führen.</span><span class="sxs-lookup"><span data-stu-id="8d969-833">Using Narrator and Magnifier at the same time may result in a crash.</span></span>
- <span data-ttu-id="8d969-834">Die gleichzeitige Verwendung der Sprachausgabe und der Bildschirmlupe kann zu einem Absturz führen.</span><span class="sxs-lookup"><span data-stu-id="8d969-834">Using Narrator and Magnifier at the same time may result in a crash.</span></span>
 
### <a name="outlook"></a><span data-ttu-id="8d969-835">Outlook</span><span class="sxs-lookup"><span data-stu-id="8d969-835">Outlook</span></span>
- <span data-ttu-id="8d969-836">Bei einer weitergeleiteten e-Mail fehlen möglicherweise eingebettete Bilder.</span><span class="sxs-lookup"><span data-stu-id="8d969-836">A forwarded e-mail may be missing embedded images.</span></span>
- <span data-ttu-id="8d969-837">Das Tool „Raumsuche“ zeigt bei verfügbaren Räumen möglicherweise &quot;Keine&quot; an.</span><span class="sxs-lookup"><span data-stu-id="8d969-837">Room Finder tool may be displaying &quot;None&quot; for available rooms.</span></span>
- <span data-ttu-id="8d969-838">Benutzer sind möglicherweise nicht in der Lage, Outlook-Profile mit strikter Mandantenbeschränkung zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="8d969-838">Users may not be able to create Outlook profiles with strict tenant restriction.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="8d969-839">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-839">PowerPoint</span></span>
- <span data-ttu-id="8d969-840">Die gleichzeitige Verwendung der Sprachausgabe und der Bildschirmlupe kann zu einem Absturz führen.</span><span class="sxs-lookup"><span data-stu-id="8d969-840">Using Narrator and Magnifier at the same time may result in a crash.</span></span>
 
### <a name="project"></a><span data-ttu-id="8d969-841">Project</span><span class="sxs-lookup"><span data-stu-id="8d969-841">Project</span></span>
- <span data-ttu-id="8d969-842">Der Benutzer kann eine Aufgabe nicht als erledigt markieren, und sie wird auf 99 % festgelegt.</span><span class="sxs-lookup"><span data-stu-id="8d969-842">User is unable to mark a task as complete, and it gets set to 99%.</span></span>
- <span data-ttu-id="8d969-843">Überlastungen werden durch einen Abgleich nicht behoben.</span><span class="sxs-lookup"><span data-stu-id="8d969-843">Overallocations are not resolved by leveling.</span></span>
 
### <a name="word"></a><span data-ttu-id="8d969-844">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-844">Word</span></span>
- <span data-ttu-id="8d969-845">Die gleichzeitige Verwendung der Sprachausgabe und der Bildschirmlupe kann zu einem Absturz führen.</span><span class="sxs-lookup"><span data-stu-id="8d969-845">Using Narrator and Magnifier at the same time may result in a crash.</span></span>
- <span data-ttu-id="8d969-846">Das Öffnen alter Dokumente und das anschließende Wechseln zur Registerkarte „Info“ kann zu einem Absturz führen.</span><span class="sxs-lookup"><span data-stu-id="8d969-846">Opening legacy documents and then going to the Info tab can cause a crash.</span></span>
- <span data-ttu-id="8d969-847">Vorschläge der Dokumentprüfung werden nicht in Kontextmenüs angezeigt.</span><span class="sxs-lookup"><span data-stu-id="8d969-847">Proofing suggestins are not displaying in contextual menus.</span></span>
- <span data-ttu-id="8d969-848">Inhaltsrichtlinien werden nicht ordnungsgemäß auf Kommentare angewendet.</span><span class="sxs-lookup"><span data-stu-id="8d969-848">Content policies are being incorrectly applied to comments.</span></span>
- <span data-ttu-id="8d969-849">Alte Kommentare, die mit dunklem Text geschrieben wurden, sind im dunklen Modus nicht sichtbar.</span><span class="sxs-lookup"><span data-stu-id="8d969-849">Legacy comments written with dark text is not visible in Dark Mode.</span></span>
- <span data-ttu-id="8d969-850">Bei Verwendung der AutoKorrektur für Koreanisch/Englisch werden möglicherweise falsche Zeichen angezeigt.</span><span class="sxs-lookup"><span data-stu-id="8d969-850">Incorrect characters may appear when using Korean/English autocorrect.</span></span>
- <span data-ttu-id="8d969-851">Niedrigere Richtlinienbezeichnungen werden möglicherweise angewendet, wenn eine höhere Richtlinienbezeichnung Vorrang haben sollte.</span><span class="sxs-lookup"><span data-stu-id="8d969-851">Lower policy labels may be applied when a higher policy label should have taken priority.</span></span>
- <span data-ttu-id="8d969-852">Die Links von cid:-Bildern aus Outlook-Nachrichten&nbsp;können nun auf Anforderung erfolgreich unterbrochen werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-852">The links of cid: images from Outlook messages&nbsp;can now be successfully broken when requested.</span></span>
- <span data-ttu-id="8d969-853">Die gleichzeitige Verwendung der Sprachausgabe und der Bildschirmlupe kann zu einem Absturz führen.</span><span class="sxs-lookup"><span data-stu-id="8d969-853">Using Narrator and Magnifier at the same time may result in a crash.</span></span>
- <span data-ttu-id="8d969-854">Die Suche im Navigationsbereich schlägt möglicherweise fehl.</span><span class="sxs-lookup"><span data-stu-id="8d969-854">Searching from the Navigation pane may fail.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="8d969-855">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-855">Office Suite</span></span>
- <span data-ttu-id="8d969-856">Einige Zeichnungen werden in der Vorschau oder in Bildschirmpräsentationen möglicherweise nicht angezeigt.</span><span class="sxs-lookup"><span data-stu-id="8d969-856">Some drawings may not display in preview or slide shows.</span></span>
- <span data-ttu-id="8d969-857">Einige Katakana-Zeichen werden in einem vertikalen Textfeld möglicherweise nicht korrekt angezeigt werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-857">Some katakana characters may display incorrectly in a vertical text box.</span></span>
- <span data-ttu-id="8d969-858">Der Versuch, eine Datei auf einer nicht verbundenen Netzwerkfreigabe zu speichern, kann zu einem Absturz führen.</span><span class="sxs-lookup"><span data-stu-id="8d969-858">Attempting to save a file to a disconnected network share may result in a crash.</span></span>
 
[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)
 
## <a name="version-1911-october-25"></a><span data-ttu-id="8d969-860">Version 1911: 25. Oktober</span><span class="sxs-lookup"><span data-stu-id="8d969-860">Version 1911: October 25</span></span>
<span data-ttu-id="8d969-861">*Version 1911 (Build 12215.20006)*</span><span class="sxs-lookup"><span data-stu-id="8d969-861">*Version 1911 (Build 12215.20006)*</span></span>
 
[//]: # (FEATUREDETAILS NICHT ENTFERNEN BEGINN INHALT)
 
### <a name="feature-updates"></a><span data-ttu-id="8d969-863">Featureupdates</span><span class="sxs-lookup"><span data-stu-id="8d969-863">Feature updates</span></span>
### <a name="visio"></a><span data-ttu-id="8d969-864">Visio</span><span class="sxs-lookup"><span data-stu-id="8d969-864">Visio</span></span>
 
- <span data-ttu-id="8d969-865">**Erstellen von ansprechenden Visio-Diagrammen in Excel:** Visualisieren Sie Ihre Daten schnell und einfach in ansprechenden Visio-Diagrammen in Excel.</span><span class="sxs-lookup"><span data-stu-id="8d969-865">**Make polished Visio diagrams in Excel:** Quickly and easily visualize your data into polished Visio diagrams within Excel.</span></span> [<span data-ttu-id="8d969-866">Weitere Informationen</span><span class="sxs-lookup"><span data-stu-id="8d969-866">Learn more</span></span>](https://support.office.com/article/bee3b5aa-aaaf-4401-acc6-276b711c763c)
 
### <a name="word"></a><span data-ttu-id="8d969-867">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-867">Word</span></span>
 
- <span data-ttu-id="8d969-868">**Verbesserungen bei der gemeinsamen Dokumenterstellung:** Die gemeinsame Dokumenterstellung wurde verbessert, indem Inhaltsänderungen den anderen Benutzern nun nahezu immer in Echtzeit angezeigt werden.</span><span class="sxs-lookup"><span data-stu-id="8d969-868">**Coauthoring improvements:** Improved the coauthoring experience by making it more likely that content changes will be received by others in real time.</span></span>
 
- <span data-ttu-id="8d969-869">**Andere sehen Ihre Änderungen schnell:** Verbesserungen bei der gemeinsamen Dokumenterstellung bewirken, dass Ihre Mitarbeiter Ihre Änderungen noch schneller erkennen können als früher.</span><span class="sxs-lookup"><span data-stu-id="8d969-869">**Others see your changes quickly:** Co-authoring improvements mean your collaborators can see your changes faster than ever before.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="8d969-872">Gelöste Probleme</span><span class="sxs-lookup"><span data-stu-id="8d969-872">Resolved issues</span></span>
### <a name="access"></a><span data-ttu-id="8d969-873">Access</span><span class="sxs-lookup"><span data-stu-id="8d969-873">Access</span></span>
 
- <div><span data-ttu-id="8d969-874"><span>Möglicherweise ist die Datensatzanzahl falsch</span></span><span class="sxs-lookup"><span data-stu-id="8d969-874"><span>The record count could be incorrect</span></span></span></div>
 
 
### <a name="excel"></a><span data-ttu-id="8d969-875">Excel</span><span class="sxs-lookup"><span data-stu-id="8d969-875">Excel</span></span>
 
- <div><span data-ttu-id="8d969-876"><span>Wir haben die Leistung beim Löschen von Spalten mit verbundenen Zellen erheblich verbessert.</span></span><span class="sxs-lookup"><span data-stu-id="8d969-876"><span>We significantly improved the performance of deleting columns with merged cells</span></span></span></div>
 
 
- <div><span data-ttu-id="8d969-877"><span>Es könnte Benutzern ggfs. nicht möglich sein, im Office 365-Format für Excel-Arbeitsmappen zu speichern</span></span><span class="sxs-lookup"><span data-stu-id="8d969-877"><span>Users could be prevented from saving in Office 365 Excel Workbook format</span></span></span></div>
 
 
- <div><span data-ttu-id="8d969-878"><span>Kontrollkästchen wurden nicht ordnungsgemäß gerendert</span></span><span class="sxs-lookup"><span data-stu-id="8d969-878"><span>Checkboxes could not render correctly</span></span></span></div>
 
 
- <div><span data-ttu-id="8d969-879"><span>Änderungen an der Größe eines Diagramms konnten nicht gespeichert werden.</span></span><span class="sxs-lookup"><span data-stu-id="8d969-879"><span>Changes to a chart size could not be saved</span></span></span></div>
 
 
- <div><span data-ttu-id="8d969-880"><span>Einige VBA-Funktionen haben bei neuen Diagrammtypen einen Fehler zurückgegeben</span></span><span class="sxs-lookup"><span data-stu-id="8d969-880"><span>Some VBA functions would return an error on new chart types</span></span></span></div>
 
 
- <div><span data-ttu-id="8d969-881"><span>Bei einigen Dialogfeldern zur Auswahl von Datenquellen wurde die Groß-/Kleinschreibung nicht beachtet</span></span><span class="sxs-lookup"><span data-stu-id="8d969-881"><span>Select Data Source dialogs were not case sensitive for some fields</span></span></span></div>
 
 
### <a name="powerpoint"></a><span data-ttu-id="8d969-882">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="8d969-882">PowerPoint</span></span>
 
- <div><span data-ttu-id="8d969-883"><span>Änderungen an der Größe eines Diagramms konnten nicht gespeichert werden.</span></span><span class="sxs-lookup"><span data-stu-id="8d969-883"><span>Changes to a chart size could not be saved</span></span></span></div>
 
 
### <a name="publisher"></a><span data-ttu-id="8d969-884">Publisher</span><span class="sxs-lookup"><span data-stu-id="8d969-884">Publisher</span></span>
 
- <div><span data-ttu-id="8d969-885"><span>Shapes konnten außerhalb des Grafikrahmens angezeigt werden</span></span><span class="sxs-lookup"><span data-stu-id="8d969-885"><span>Shapes could appear outside of the graphics border</span></span></span></div>
 
 
### <a name="word"></a><span data-ttu-id="8d969-886">Word</span><span class="sxs-lookup"><span data-stu-id="8d969-886">Word</span></span>
 
- <div><span data-ttu-id="8d969-887"><span>Shapes konnten außerhalb des Grafikrahmens angezeigt werden</span></span><span class="sxs-lookup"><span data-stu-id="8d969-887"><span>Shapes could appear outside of the graphics border</span></span></span></div>
 
 
- <div><span data-ttu-id="8d969-888"><span>Das Hervorheben von Text kann sich schwierig gestalten</span></span><span class="sxs-lookup"><span data-stu-id="8d969-888"><span>Highlighting text could be challenging</span></span></span></div>
 
 
- <div><span data-ttu-id="8d969-889"><span>Ein Benutzer konnte daran gehindert werden, zu einem einzelnen Element im Editor zu navigieren.</span></span><span class="sxs-lookup"><span data-stu-id="8d969-889"><span>A user could be prevented from navigating to an individual item in the editor</span></span></span></div>
 
 
- <div><span data-ttu-id="8d969-890"><span>Möglicherweise wurden Grammatik- oder Rechtschreibfehler nicht hervorgehoben</span></span><span class="sxs-lookup"><span data-stu-id="8d969-890"><span>Grammar or spelling errors might not be highlighted</span></span></span></div>
 
 
- <div><span data-ttu-id="8d969-891"><span>Änderungen an der Größe eines Diagramms konnten nicht gespeichert werden.</span></span><span class="sxs-lookup"><span data-stu-id="8d969-891"><span>Changes to a chart size could not be saved</span></span></span></div>
 
 
- <div><span data-ttu-id="8d969-892"><span>Eine Visitenkarte konnte ggfs. nicht mehr geöffnet werden, nachdem eine Formatierung auf @mention angewendet wurde</span></span><span class="sxs-lookup"><span data-stu-id="8d969-892"><span>A contact card could be prevented from opening after apply formatting to an @ mention</span></span></span></div>
 
 
- <div><span data-ttu-id="8d969-893"><span>Ein Problem wurde behoben, bei dem Nutzer ggfs. Word, Excel- und PowerPoint-Dokumente nicht mehr speichern konnten.&nbsp; Dieses Problem betraf Benutzer, die eine neue Datei erstellten und das Dialogfeld &quot;Modell speichern&quot; öffneten, nachdem Sie auf das Symbol "Speichern" geklickt oder STRG + S gedrückt hatten.</span></span><span class="sxs-lookup"><span data-stu-id="8d969-893"><span>Resolvedan issue where users may be unable to save Word, Excel, and PowerPoint documents.&nbsp; This issue affects users that create a new file and bring up the &quot;Save as Model Dialog&quot; option after clicking on the Save icon or pressing Ctrl + S.</span></span></span></div>
 
 
### <a name="office-suite"></a><span data-ttu-id="8d969-894">Office-Suite</span><span class="sxs-lookup"><span data-stu-id="8d969-894">Office Suite</span></span>
 
- <div><span data-ttu-id="8d969-895"><span>Leistungsproblem bei der Verwendung von Shapes unter Windows 7</span></span><span class="sxs-lookup"><span data-stu-id="8d969-895"><span>Performance issue when using Shapes on Windows 7</span></span></span></div>
