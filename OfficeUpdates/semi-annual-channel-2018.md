...
> - Diese Informationen gelten auch für Office 365 Business, die Version von Office, die einige Office 365-Plänen umfasst, wie z.B. Business Premium.
...
## <a name="version-1708-august-14"></a>Version 1708: August 14
...
-   [CVE-2018-8248](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0907): Sicherheitsanfälligkeit in Microsoft Excel bezüglich der Remotecodeausführung
-   [CVE-2018-0907](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0907): Umgehung von Sicherheitsfunktionen in Microsoft Office Excel
...
-   Problem behoben, bei dem die Verwendung des Schnelldrucks für eine Excel-Arbeitsmappe nicht funktionierte, die einer Outlook-E-Mail angefügt war.
...
-   Neue Anrufe und Unterhaltungen werden beim Koppeln mit Aries-Telefonen unterdrückt, wenn RedirectClient aktiviert ist.
...
-   Behebung eines Problems, aufgrund dessen Benutzer in der Lobby nicht benachrichtigt werden, wenn ihr Beitritt zur Besprechung verweigert wird.
...
-   **Dateispeicherorte nach Konto:** Beim Öffnen oder Speichern einer Datei wird die Liste der Orte nach dem zugeordneten Konto organisiert.
-   **Stiftanpassung:** Wählen Sie einen persönlichen Satz von Stiften und Textmarkern für die Freihandeingabe aus. Ihr benutzerdefinierter Satz steht Ihnen dann auf all Ihren Windows-PCs zur Verfügung.
-   **Verbesserte Unterstützung beim Verfassen im Editorbereich:** Verwenden Sie den Editorbereich für erweiterte Empfehlungen zu Rechtschreibung, Grammatik und Schreibstil. Es ist so konzipiert, dass es mit verbesserter Unterstützung für unterstützende Technologien zugänglich ist.

### <a name="word-security-updates"></a>Word: Sicherheitsupdates
-   [CVE-2018-0792](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0792): Microsoft Office – Sicherheitsrisiko bei Remotecodeausführung
-   [CVE-2018-0793](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0793): Microsoft Outlook – Sicherheitsrisiko bei Remotecodeausführung
...
-   Behebung eines Problems, bei dem Word auf Computern unter Windows 7 ohne das Update für Benutzerfreundlichkeit und Diagnosetelemetrie nicht geöffnet werden konnte.
...
### <a name="excel-security-updates"></a>Excel: Sicherheitsupdates
-   [CVE-2018-8246](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8246): Microsoft Excel – Sicherheitsrisiko bei der Offenlegung von Informationen
-   [CVE-2018-8248](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8248): Sicherheitsanfälligkeit in Microsoft Excel bezüglich der Remotecodeausführung
...
-   Behebung eines Problems, aufgrund dessen ein Benutzer eine Arbeitsmappe in der geschützten Ansicht nicht schließen kann, wenn der Dateiname eckige Klammern enthält.
-   Behebung eines Problems, aufgrund dessen Excel abstürzt, wenn der Benutzer beim Versuch, ein Objekt in eine vorhandene Arbeitsmappe einzufügen, auf „Durchsuchen“ klickt.
-   Behebung eines Problems, aufgrund dessen bei Auswahl von „Größe der Form dem Text anpassen“ (im Abschnitt „Textoptionen/Textfeld“ des Bereichs „Form formatieren“) keine Änderung an der Form vorgenommen wird.
...
-   Behebung eines Problems, aufgrund dessen Registerkarten ignoriert werden, wenn ein mit Tabulator getrennter Text aus Word kopiert und eingefügt wird, sodass der Text nicht in Spalten eingefügt wird.
-   Behebung eines Problems, aufgrund dessen Excel beim Öffnen des Dialogfelds „Als Webseite veröffentlichen“ abstürzt.
-   Behebung eines Problems, aufgrund dessen eine Datenaktualisierung nicht erfolgreich ausgeführt werden kann oder Excel abstürzt, wenn Daten von einem SQL Server Analysis Services-Server verwendet werden und sich das Gebietsschema von Excel und das Gebietsschema des SQL Server Analysis Services-Servers voneinander unterscheiden.
...
-   Behebung eines Problems, aufgrund dessen Projekt beim Öffnen bestimmter Dateien aus Projekt Online abstürzt.
...
-   Es wurde ein Problem behoben, sodass Projekt-Dateien von einem Dateiserver mit hoher Latenz nun schneller geöffnet werden.
...
-   Behebung eines Problems, aufgrund dessen Formen im Zeichnungsbereich nicht gedreht werden können.
