...
> - Diese Information gilt auch für Office 365 Business, die Version von Office, die mit einigen Office 365-Plänen geliefert wird, wie z.B. Business Premium.
> - Wir führen oft Features (und manchmal sogar Korrekturen) für den monatlichen Kanal über einen längeren Zeitraum ein. Auf diese Weise können wir sicherstellen, dass die Dinge reibungslos funktionieren, bevor wir das Feature an eine breitere Benutzergruppe weitergeben. Wenn Sie also etwas nicht sehen, das unten beschrieben ist, machen Sie sich keine Sorgen, Sie werden es irgendwann erhalten. [Weitere Informationen](https://support.office.com/en-us/article/when-do-i-get-the-newest-features-in-for-office-365-da36192c-58b9-4bc9-8d51-bb6eed468516?ui=en-US&rs=en-US&ad=US)
...
-   [CVE-2018-8501](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8501): Sicherheitsrisiko in Microsoft PowerPoint bezüglich der Remotecodeausführung

### <a name="word-security-updates"></a>Word: Sicherheitsupdates 
-   [CVE-2018-8504](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8504): Microsoft Word – Sicherheitsrisiko bezüglich der Remotecodeausführung 
-   [ADV180026](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/ADV180026): Microsoft Office – Intensiver Schutz – Update 
...
- **Teilnehmen an Teambesprechungen über das Dialogfeld "Outlook-Erinnerungen":** Wenn Outlook Benutzer an eine anstehende Besprechung erinnert, wird eine Schaltfläche „Online teilnehmen“ angezeigt, falls die anstehende Besprechung eine Onlinebesprechung der Teams ist. Dieser Vorgang ähnelt der Teilnahme an einer Skype for Business-Besprechung im Dialogfeld „Outlook-Erinnerungen“.
...
### <a name="office-suite-non-security-updates"></a>Office-Suite: Nicht sicherheitsrelevante Sicherheitsupdates
 - Eine Reihe von Problemen wurde behoben, die einige Benutzer am Öffnen von IRM-geschützten Dokumenten und E-Mails hinderten, die von Personen in anderen Organisationen für sie freigegeben wurden.
...
### <a name="access-security-updates"></a>Access: Sicherheitsupdates
-   [CVE-2018-8312](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8312): Microsoft Access Remotecode-Ausführung, unter Verwendung des Use-After-Free-Sicherheitsrisikos
...
### <a name="outlook-feature-updates"></a>Outlook: Featureupdates
 - **Serienstandard:** Im Dialogfeld „Terminserie“ (unter „Seriendauer“) ist „Endet am“ die Standardeinstellung (anstelle von „Kein Enddatum“); dies ist auch die erste aufgeführte Einstellung, und ein Standardenddatum ist festgelegt.
...
### <a name="project-feature-updates"></a>Projekt: Featureupdates
 - **Organisiert bleiben mit zuletzt verwendeten Speicherorten:** In Projekt wird eine fortlaufende Liste davon geführt, wo Sie andere Projekte gespeichert haben. Wenn Sie bereit sind, Ihr Projekt zu speichern, wählen Sie einfach einen der zuletzt verwendeten Speicherorte aus, und arbeiten Sie weiter.
...
### <a name="excel-security-updates"></a>Excel: Sicherheitsupdates
-   [CVE-2018-8246](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8246): Microsoft Excel – Sicherheitsrisiko bezüglich der Veröffentlichung von Informationen
...
### <a name="outlook-non-security-updates"></a>Outlook: Nicht sicherheitsrelevante Sicherheitsupdates
- Ändern Sie die Formulierung in einer Einladung zum Freigeben eines Kalenders von „Diesen Kalender öffnen“ auf „Zustimmen.“
...
### <a name="word-feature-updates"></a>Word: Featureupdates
 ...
 - **Freisprech-Eingabe:** Diktieren Sie Ihre Dokumente ganz einfach, ohne zu tippen. [Weitere Informationen](https://support.office.com/article/d4fd296e-8f15-4168-afec-1f95b13a6408)
 - **Natürliche Bearbeitung mit dem Freihand-Editor:** Mit einem einzigen Strich können Sie Wörter trennen oder verbinden, eine neue Zeile hinzufügen oder mit einem Stift Wörter einfügen. [Weitere Informationen](https://support.office.com/article/7edbcf8e-0004-484d-9b62-501a31c23ee9)
...
-   [CVE-2018-8163](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8163): Sicherheitsrisiko bei der Veröffentlichung von Microsoft Excel-Informationen
...
-   **Verschlüsselungsoption:** Benutzer der Office 365-Nachrichtenverschlüsselung können Nachrichten verschlüsselt und an eine beliebige Person innerhalb oder außerhalb ihrer Organisation senden. Die Verschlüsselungsoption wird beim Erstellen einer Nachricht unter „Optionen \> Berechtigungen“ angezeigt. [Weitere Informationen](https://aka.ms/omeoverview)
...
-   **Sprintnavigation:** Wechseln Sie von einer Sprintansicht zur anderen, und verschieben Sie schnell Aufgaben zwischen den Sprints.

### <a name="word-feature-updates"></a>Word: Featureupdates
-   **Suchen und Beheben von Problemen bei der Dokumentenprüfung:** Im Bearbeitungsbereich wird jetzt eine Übersicht der Dokumentenprüfungsprobleme angezeigt, die in Ihrem Dokument gefunden werden, der Fokus liegt also auf der Behebung der Probleme, die für Sie am stärksten relevant sind.
...
### <a name="office-suite-security-updates"></a>Office-Suite: Sicherheitsupdates
-   [CVE-2018-0950](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0950): Microsoft Office – Sicherheitsrisiko bezüglich der Veröffentlichung von Informationen
-   [CVE-2018-1026](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-1026): Sicherheitsrisiko in Microsoft Office bezüglich Remotecodeausführung
...
-   Beheben Sie ein Problem, bei dem OneDrive for Business (Groove.exe) die Auslastung eines einzelnen Kerns (zum Beispiel 25 % bei einer CPU mit 4 Kernen) für längere Zeit im Task Manager beansprucht.
