...
## <a name="version-2004-june-09"></a>Version 2004: Juni 09
...
- **Eine flexiblere "An:"-Zeile:** Wenn Sie in die Zeile "An:" klicken, um eine Nachricht zu adressieren, schlagen wir Ihnen Empfänger vor, die Sie wahrscheinlich auswählen werden. Außerdem können Sie Ihr Bild sehen, damit Sie wissen, dass Sie an die richtige Person senden. [Weitere Informationen](https://support.office.com/article/147208af-ca8e-4cdf-b71f-77ba81a54069)
...
- **Erstellen von barrierefreien PDF-Dateien:** Erstellen Sie eine PDF-Datei, und die Barrierefreiheitsprüfung weist auf Barrierefreiheitsprobleme hin, die vor dem Speichern behoben werden sollten.<br />Weitere Detailinformationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2019/08/13/accessible-pdfs-made-easier/).
...
- **Suchen und beheben Sie relevante Korrektur Probleme.:** Im Editor Bereich wird jetzt eine Übersicht Überkorrektur Probleme angezeigt, die in Ihrem Dokument gefunden werden, daher liegt der Schwerpunkt auf der Behebung der für Sie relevanten.
...
- Es wurde ein Klick-und-Los-Problem behoben, das zu einem Fehler beim Versuch führte, symbolische Links hart zu verknüpfen.
...
## <a name="version-2003-june-09"></a>Version 2003: Juni 09
...
- **GIFs im Handumdrehen:** eine Folie, ein Frame. Erstellen Sie auf einfache Weise Schleifen-GIFs in PowerPoint. [Weitere Informationen](https://support.office.com/article/a598753e-92de-4f1b-8393-714db4d334b4)<br />Weitere Detailinformationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2019/12/30/create-animated-gifs-using-powerpoint/).
...
- **Aktualisieren von Folien während der Bildschirmpräsentation:** Aktualisieren Sie Folien, die von anderen Autoren während Ihrer Präsentation geändert wurden.<br />Einzelheiten finden Sie im [Blogbeitrag](https://blog-insider.office.com/2020/04/08/synchronize-changes-while-presenting/).
...
- Die Synchronisierungs- und Servicestabilität wurde durch vorübergehende Reduzierung der maximal zulässigen Größe neuer eingebetteter Anlagen in OneNote 2016 auf 50 MB verbessert. Bei Dateien, die dieses Limit überschreiten, haben Benutzer die Möglichkeit, die Datei auf OneDrive hochzuladen und einen Link in OneNote einzufügen.
...
- Es wurde ein Problem behoben, das dazu führte, dass Benutzer gelegentlich einen Absturz erlebten, wenn sie die Taste auf ihrer Maus verwendeten.
...
- Es wurde ein Problem behoben, bei dem der Benutzer keine geplante Arbeit mit Zeitphasen eingeben konnte, wenn die Einstellung zum Schützen der aktuellen Arbeit aktiviert war.
...
- Behebt ein Problem, das gelegentlich zu einem Absturz führte, wenn Benutzer auf ihrer Maus die Taste "X" benutzten.
