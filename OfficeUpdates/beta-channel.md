...
## <a name="version-2108-july-16"></a>Version 2108: 16. Juli
...
- Es wurde ein Problem behoben, bei dem kleine Datenmarker beim Verkleinern der Kalkulationstabelle verschwunden sind.


- Es wurde ein Problem behoben, bei dem eine andere Arbeitsmappe geöffnet wurde, wenn eine Arbeitsmappe geschlossen und dann wieder geöffnet werden sollte, weil sie von einem anderen Benutzer geändert und eingecheckt wurde.


- Es wurde ein Problem mit geschützten Dateien ohne Bezeichnungsmetadaten behoben; die Bezeichnung wird durch den Schutz bestimmt. Die obligatorische Bezeichnung verwendet nun Bezeichnungsmetadaten und Bezeichnungsrichtlinien.


### <a name="word"></a>Word

- Es wurde ein Problem behoben, bei dem die Korrektureinstellungen nicht beibehalten wurden.


- Es wurde ein Problem behoben, bei dem Aufzählungszeichen während der gemeinsamen Dokumenterstellung aus dem Text verschwinden konnten.


- Es wurde ein Problem im Zusammenhang mit dem Speichern von Dateien behoben.



[//]: # (BUGDETAILS NICHT ENTFERNEN ENDE INHALT)

## <a name="version-2108-july-09"></a>Version 2108: 9. Juli
...
- Es wurde ein Problem behoben, bei dem eine mit PowerPoint verknüpfte Datei nicht mehr verfügbar war, wenn die XLSX-Quelldatei bereits im Hintergrund ausgeführt wird und beide Dateien aus dem lokalen synchronisierten ODB-Ordner geöffnet werden.


- Ein Problem wurde behoben, bei dem lokalisierte Funktionsnamen nun beim Öffnen von CSV-Dateien erkannt werden.


### <a name="word"></a>Word

- Ein Problem im Zusammenhang mit einer zu kleinen Druckgröße in Word Mobile wurde behoben.


- Es wurde ein Problem behoben, bei dem eine zu einer SharePoint-Dokumentenbibliothek hinzugefügte Datei sofort nach dem Öffnen die Einstellung „ShowDocument Information Panel“ übernahm und diese auch dann noch vorhanden war, wenn die Datei aus SharePoint entfernt wurde.


- Ein Problem wurde behoben, bei dem ein Ordnername, der nicht mit „/“ endet, vom URL-Parser falsch interpretiert wurde.


### <a name="office-suite"></a>Office-Suite

- Ein Problem wurde behoben, bei dem hinzugefügte DropShadow-Eigenschaften im Suchfeld dazu führten, dass die Titelleiste (TitleBar) zu hoch war, was Layoutfehler verursachte.
...
## <a name="version-2107-june-18"></a>Version 2107: 18. Juni
...
- **Organisationsexplorer:** Anzeigen des und Navigieren im Organigramm.
...
- Dieser Registrierungsschlüssel deaktiviert die neue Erfahrung für die Raumsuche (dieselbe Erfahrung wie in Outlook für Web), und er aktiviert die Vorgängerversion der Raumsuche mit „Vorgeschlagene Zeiten“.
...
- Es wurde ein Problem behoben, das zu einer Nichtübereinstimmung zwischen dem Thema des Bearbeitungsbereichs und dem Systemthema führte.
...
- Ein Problem wurde behoben, das dazu führte, dass Word unerwartet geschlossen wurde, wenn lautes Vorlesen mit anderen Versionen von Windows verwendet wurde.
...
- **Vorgeschlagene Antworten in Outlook für Windows:** Wenn Sie eine E-Mail-Nachricht erhalten, die mit einer kurzen Antwort beantwortet werden kann, kann Outlook drei Antworten vorschlagen, mit denen Sie mit nur wenigen Klicks antworten können.
...
## <a name="version-2104-march-26"></a>Version 2104: 26. März
...
- **Flipgrid-Videos in PowerPoint einfügen:** PowerPoint unterstützt jetzt das Einfügen von Flipgrid-Videos in Folien.
...
### <a name="excel"></a>Excel
- **Vertraulichkeitsbezeichnungen**: Sie können jetzt eine von Ihrer Organisation konfigurierte Vertraulichkeitsbezeichnung anwenden, um benutzerdefinierte Berechtigungen anzufordern. [Weitere Informationen](/microsoft-365/compliance/encryption-sensitivity-labels?preserve-view=true&view=o365-worldwide#let-users-assign-permissions)
