...
## <a name="version-2008-april-13"></a>Version 2008: 13. April
...
- Ein Problem wurde behoben, das bei einigen Benutzern zu einem unerwarteten Schließen beim Synchronisieren ihres Postfachs führte.


### <a name="powerpoint"></a>PowerPoint

- Ein Problem wurde behoben, das dazu führte, dass Office-Anwendungen nicht mehr reagierten, nachdem eine Personenkarte aufgerufen und zu einer anderen Anwendung navigiert wurde.


### <a name="word"></a>Word

- Ein Problem wurde behoben, bei dem die integrierte Schaltfläche „Vertraulichkeitsbezeichnung“ ausgegraut wird, wenn ein Word-Dokument gespeichert und erneut geöffnet wird.



[//]: # (BUGDETAILS NICHT ENTFERNEN INHALTSENDE)

## <a name="version-2002-april-13"></a>Version 2002: 13. April
*Version 2002 (Build 12527.21814)*

Sicherheitsupdates werden [hier](https://docs.microsoft.com/officeupdates/microsoft365-apps-security-updates) aufgeführt

## <a name="version-2008-march-09"></a>Version 2008: 09. März
...
- Es wurde ein Problem behoben, das dazu führen konnte, dass die Anwendung bei einem Fehler beim Speichern eines Dokuments unerwartet geschlossen wurde.


- Behebt ein Problem, bei dem die Auswahl einer Designidee in bestimmten Fällen die Kennzeichnung der Datenklassifizierung der Präsentation entfernt.
...
- Ein Problem wurde behoben, bei dem durch das Kopieren/Einfügen in Skype for Business-Nachrichten ein Dialogfeld mit der Meldung „Beim Einfügen Ihres Inhalts ist etwas schief gelaufen“ angezeigt wurde.



[//]: # (BUGDETAILS NICHT ENTFERNEN INHALTSENDE)

## <a name="version-2002-march-09"></a>Version 2002: 09. März
...
- **Ziehen Sie E-Mails in eine Gruppe, die Sie besitzen:** Verschieben und Kopieren von Nachrichten und Unterhaltungen, indem Sie diese aus Ihrem Posteingang ziehen. Die von ihnen gezogenen Nachrichten werden für alle Gruppenmitglieder freigegeben.<br />Weitere Detailinformationen finden Sie unter [Blogbeitrag](https://blog-insider.office.com/2020/03/02/drag-messages-from-your-personal-inbox-to-the-group-mailbox/)

- **An Besprechungen teilnehmen, ohne den Posteingang zu verlassen:** Sie brauchen nicht zu Ihrem Kalender zu wechseln, um an Onlinebesprechungen teilzunehmen. Wenn der Kalender an den Aufgabenbereich angeheftet ist, können Benutzerkonten, die auf Exchange Server 2019 oder Exchange Online gehostet werden, jeder Besprechung mit nur einem Klick beitreten. [Weitere Informationen](https://support.office.com/article/d8baa9d5-0645-41b8-9f36-b498a6c36064 )
...
- **GIFs im Handumdrehen:** eine Folie, ein Frame. Erstellen Sie auf einfache Weise Schleifen-GIFs in PowerPoint. [Weitere Informationen](https://support.office.com/article/a598753e-92de-4f1b-8393-714db4d334b4)<br />Weitere Detailinformationen finden Sie unter [Blogbeitrag](https://blog-insider.office.com/2019/12/30/create-animated-gifs-using-powerpoint/)
...
- Ein Problem wurde behoben, bei dem die Anwendung unerwartet geschlossen wurde, wenn ein Zoom-Fenster verwendet wurde.
...
- Durch diese Änderung wird ein Problem behoben, das beim Starten des Zoom-Felds (UMSCHALT+F2) zum Bearbeiten von Text zum unerwarteten Schließen von Access führen könnte.
...
- Ein Problem wurde behoben, um den Datentyp Datum/Uhrzeit in Ihrem Code aufrufen zu können, ohne dass es zu Problemen in Ihrer App kommt.
...
- Es wurde ein Fehler beim Versuch, den ODBC-DSN-Generator zu verwenden, behoben
...
- Ein Problem wurde behoben, das beim Versuch, eine Datenverbindung herzustellen, auftreten konnte, wenn Sie sich von Ihrem Konto abgemeldet haben.


- Ein Fehler in PivotDateFilter-APIs, in denen die Filterbedingungen "Vorher" und "Nachher" vertauscht waren, wurde behoben.


- Ein Problem wurde behoben, bei dem Excel unerwartet geschlossen werden kann, wenn versucht wird, PivotTables in ein Diagrammblatt einzufügen.


- Ein Problem wurde behoben, bei dem Pivot-Tabellen nicht bearbeitet und Arbeitsmappen nicht gespeichert werden konnten, wenn sie aus dem Projektplan exportiert wurden.
...
- Es wurde ein Problem behoben, bei dem Excel unter bestimmten Umständen unerwartet geschlossen wurde, wenn "Format übertragen" verwendet wurde.
...
- Es wurde ein Problem behoben, durch das Excel unerwartet geschlossen werden kann, wenn die Schnellanalyse nach dem Fixieren der obersten Zeile des Blatts verwendet wird.
...
- Ein Problem wurde behoben, bei dem Excel in manchen Fällen unerwartet geschlossen wurde, nachdem ein Blatt mit einer PivotTable kopiert wurde.
...
- Ein Problem wurde behoben, bei dem die Verwendung von Echtzeitdaten in Verbindung mit Multithread-Neuberechnungsfunktionen zum unerwarteten Schließen der Anwendung führen konnte.
...
- Es wurde ein Problem behoben, durch das eine Warnung zu einer beschädigten Arbeitsmappe verursacht werden konnte, wenn sie Formeln enthielt, die WENNV() verwendeten.
...
- Wir haben ein Problem behoben, bei dem das Rechtschreibprüfungsmenü nicht geladen wurde.


### <a name="outlook"></a>Outlook

- Es wurde ein Problem behoben, bei dem optionale verbundene Erfahrungen das Laden von Web-Add-Ins blockierten.  Weitere Informationen finden Sie hier: https://developer.microsoft.com/en-us/office/blogs/outlook-add-ins-and-optional-connected-experiences/.
...
- Behebt ein Problem, das bei der Interaktion mit Cloud-Anlagen gelegentlich zum Schließen führte.


- Ein Problem wurde behoben, das zu einem Problem führte, wenn Benutzer von CLP die Absenderadresse in einer Antwort von geschütztem in ungeschützten Kontext wechselten.
...
- Es wurde ein Problem behoben, das dazu führte, dass es bei Benutzern in einigen Szenarios zeitweilig zum Hängen und Schließen kam.


- Es wurde ein Problem behoben, das zu einem Problem führte, wenn Benutzende beim Löschen von 4 oder mehr E-Mails von einem POP-Konto mit der Option "Nur Kopfzeilen herunterladen" einen Absturz erlebten.
...
- Es wurde ein Problem behoben, aufgrund dessen bei Benutzern Probleme in MAPI-Anwendungen von Drittanbietern auftraten.


- Es wurde ein Problem behoben, durch das Outlook nach einem Windows-Update beim Öffnen von lokal gespeicherten MSG- oder OFT-Dateien unerwartet geschlossen wurde.
...
- Es wurde ein Problem behoben, das dazu führte, dass Benutzer gelegentlich ein Problem feststellten, wenn Sie den X-Knopf auf ihrer Maus verwendeten.
...
- Wir haben ein Problem behoben, bei dem die Optionen „Nur verschlüsseln“ und „Nicht weiterleiten“ in einigen Szenarios aktiviert blieben, obwohl Sie per Richtlinie deaktiviert waren.
...
- Ein Problem wurde behoben, das gelegentlich zu unerwartetem Schließen führte, wenn Benutzer Persona-Informationen abriefen.


- Dies behebt ein Problem, das beim Bearbeiten von Empfängern gelegentlich zum Schließen von Anwendungen führte.
...
- Es wurde ein Problem behoben, bei dem beim Einreichen von Feedback aus einer Administratorbenachrichtigung ein plötzliches Schließen verursacht wurde.
...
- Ein Problem, das auftrat, wenn in einer Datei sowohl moderne als auch ältere Kommentare verwendet wurden, wodurch ein Upgrade der Kommentare ausgelöst wurde, wurde behoben.


- Es wurde ein Problem mit dem Vorschlagsbereich behoben, das dazu führen konnte, dass die Anwendung unerwartet geschlossen wurde.


- Wir haben ein Problem im Dialogfeld „Aktionseinstellungen“ behoben, das zum unerwarteten Schließen der PowerPoint-App geführt hat.


- Es wurde ein Problem mit der PowerPoint-App behoben, das zu deren unerwartetem Schließen führen konnte.
...
- Wir haben ein Problem behoben, bei eine Bildschirmpräsentation in der geschützten Ansicht nicht funktioniert hat.
...
- Ein Problem wurde behoben, bei dem Project beim Speichern von Projekten, die mit älteren Project-Versionen erstellt wurden, möglicherweise unerwartet geschlossen wird.
...
- Wir haben ein Problem behoben, durch das die Echtzeitvorschau bei der Textausrichtung unerwartet geschlossen wurde.
...
- Behebt ein Problem, das zu einem Problem beim Beantworten oder Verfassen neuer E-Mails führte.


- Es wurde ein Problem behoben, das dazu führte, dass Benutzer gelegentlich ein Problem feststellten, wenn Sie den X-Knopf auf ihrer Maus verwendeten.


- Es wurde ein Problem behoben, bei dem es zu einem Problem kam, wenn Benutzer bestimmte sehr große E-Mails öffneten.


- Wir haben ein Problem behoben, bei dem bei eingefügten, nummerierten Überschriften ein zusätzlicher Einzug angezeigt wurde.
...
- Es wurde ein Problem behoben, das beim Öffnen eines Dokuments zu Problemen führen konnte.
...
- Behebt einen Fehler bei Kommentarerweiterungen, wobei die Kommentarantwort dieselbe Erweiterung wie der übergeordnete Kommentar erhielt.
...
- Es wurde ein Problem behoben, das dazu führen konnte, dass die Anwendung beim Starten unerwartet geschlossen wurde.
...
- Bei dem alten, nicht webdienstbasierten Bereich „Freigeben“ wurde ein Problem behoben, bei dem das Schließen des Dokuments bei geöffnetem Bereich „Freigeben“ zum unerwarteten Schließen der Anwendung führen konnte.


- Es wurde ein Timingproblem behoben, das dazu führen konnte, dass die Anwendung beim Schließen von Office-Dateien unerwartet geschlossen wurde.
...
- Diese Änderung behebt die Ursache für eine Problem, das beim Starten von Office-Apps auftrat, weil die Datei "d2d1.dll" nicht geladen werden konnte.


- Der Office-Host wird unerwartet in Fenstern geschlossen, wenn ein Add-In aktiviert wird, während der Registrierungsschlüssel HKEY_CURRENT_USER\Software\Microsoft\Internet Explorer\Main\TabProcGrowth auf Null gesetzt ist. Mit dieser Änderung wird dieses Problem behoben.
...
- Es wurde ein Problem behoben, das beim Ziehen einiger Inhalte aus der App möglicherweise zu einem unerwarteten Schließen führte.
...
- Es wurde ein Fehler behoben, der bewirkte, dass nach dem Laden einer Arbeitsmappe bestimmte Funktionen falsche Ergebnisse aufwiesen.


- Es wurde ein Problem wurde behoben, bei dem die Anwendung unerwartet beendet wurde, was mit XLAM-Add-In-Verweisen und benannten Bereichen zusammenhing.


- Ein Problem wurde behoben, bei dem beim Ausführen des Makros für erweiterte Filter Fehler falsch gemeldet wurden.


### <a name="outlook"></a>Outlook

- Es wurde ein Problem behoben, das dazu führte, dass interne Add-Ins unerwartet deaktiviert wurden, wenn optionale verbundene Erfahrungen deaktiviert wurden.


- Es wurde ein Problem behoben, das bewirkte, dass Benutzer nicht in der Lage waren, als oder im Namen einer Verteilerliste zu senden, die in der globalen Adressliste ausgeblendet war.



[//]: # (NICHT ENTFERNEN BUGDETAILS ENDE INHALT)

## <a name="version-1908-november-10"></a>Version 1908: 10. November
*Version 1908 (Build 11929.20974)*

Sicherheitsupdates sind [hier](./microsoft365-apps-security-updates.md) aufgeführt.

## <a name="version-2002-october-13"></a>Version 2002: 13. Oktober
...
- Wenn Sie sich entscheiden, unsere Filterfunktion nach unserem Abfrage-Designer zu verwenden, sollte Ihre Datenbank nicht mehr abstürzen. Bitte überprüfen Sie dies entsprechend.
...
- Neue Präsentationen, die auf der Grundlage einer Vorlage erstellt wurden, konnten eine Einstellung erben, die eine fehlerfreie Umgebung für die gemeinsame Dokumenterstellung verhinderte. Mit diesem Fix wird sichergestellt, dass die Einstellung in diesem Fall gelöscht wird.


### <a name="word"></a>Word

- Ein Problem wurde behoben, bei dem der Benutzer beim Öffnen von Dokumenten mit Seitenumbrüchen und Spalten eine Fehlermeldung erhalten konnte: "Sie haben die maximal von Microsoft Word unterstützte Seitenzahl überschritten, oder das Dokument ist beschädigt".
...
## <a name="version-1908-october-13"></a>Version 1908: 13. Oktober
...
## <a name="version-2002-september-08"></a>Version 2002: 08. September
...
## <a name="version-1908-september-08"></a>Version 1908: 08. September
...
## <a name="version-1908-august-11"></a>Version 1908: 11. August
*Version 1908 (Build 11929.20934)*

Sicherheitsupdates sind [hier](./microsoft365-apps-security-updates.md) aufgeführt

## <a name="version-1902-august-11"></a>Version 1902: 11. August
...
- **Erstellen von barrierefreien PDF-Dateien:** Erstellen Sie eine PDF-Datei, und die Barrierefreiheitsprüfung weist auf Barrierefreiheitsprobleme hin, die vor dem Speichern behoben werden sollten. [Weitere Informationen](https://support.office.com/article/064625e0-56ea-4e16-ad71-3aa33bb4b7ed)<br />Weitere Detailinformationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2019/08/13/accessible-pdfs-made-easier/)
...
- **Konvertieren von Dateien zur Verbesserung der Barrierefreiheit:** Aktualisieren Sie Ihre Dateien auf das moderne Format, damit alle Personen einfacher darauf zugreifen können.<br />Weitere Informationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2019/10/07/take-full-advantage-of-accessibility-in-office-documents/)
...
- **Zeichnen Sie es auf:** Verleihen Sie Office-Shapes in Ihrer Arbeitsmappe ein ungezwungenes, von Hand gezeichnetes Aussehen. [Weitere Informationen](https://support.office.com/article/ec2e4491-d3bf-4266-beac-f6298fdfde9f)<br />Weitere Detailinformationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2019/07/03/sketchy-shapes-for-word-powerpoint-and-excel/)
...
- **Sechs leistungsfähige Funktionen:** Wir haben sechs neue Funktionen hinzugefügt, um Ihre Tabellenkalkulationen aufzuladen: FILTERN, SORTIEREN, SORTIERENNACH, EINDEUTIG, SEQUENZ und ZUFALLSMATRIX. [Weitere Informationen](https://support.office.com/article/003df6c7-1dcb-4388-8e2e-0fe77a0887bc)

- **Ein Blick nach links, ein Blick nach rechts... XVERWEIS ist da!:** Zeile für Zeile finden Sie mit XVERWEIS alles, was Sie in einer Tabelle oder einem Bereich benötigen. [Weitere Informationen](https://support.office.com/article/b7fd680e-6d10-43e6-84f9-88eae8bf5929)<br />Weitere Detailinformationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2019/08/29/announcing-xlookup/)

- **Zähmen Sie Ihre große Arbeitsmappe:** Zellen, Formeln, Diagramme, Tabellen ... Erhalten Sie eine Momentaufnahme Ihrer Arbeitsmappe mit Arbeitsblattstatistiken.

- **Auf die Schnelle lesen und antworten:** Antworten Sie auf Kommentare und Erwähnungen direkt aus dem E-Mail-Bereich, ohne die Arbeitsmappe zu öffnen.
...
- **Erhalten Sie Ortsvorschläge:** Beginnen Sie beim Planen von Terminen und Besprechungen mit der Eingabe im Feld „Ort“, so schlägt Outlook Räume, Adressen und andere zuletzt verwendete Orte vor. [Weitere Informationen](https://support.office.com/article/1d8631be-611a-4e3d-9109-b153e4622d53)<br />Weitere Detailinformationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2019/07/08/location-suggestions-in-outlook-for-windows/)
...
- **Suchen bei Rechtschreibschwierigkeiten oder Tippfehlern:** Outlook wird auch dann finden, was Sie suchen, wenn Sie sich verschreiben.
...
- **Zeichnen Sie es auf:** Verleihen Sie Office-Shapes in Ihrer Präsentation ein ungezwungenes, von Hand gezeichnetes Aussehen. [Weitere Informationen](https://support.office.com/article/ec2e4491-d3bf-4266-beac-f6298fdfde9f)<br />Weitere Detailinformationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2019/07/03/sketchy-shapes-for-word-powerpoint-and-excel/)

- **Wiedergabe von animierten Freihandzeichnungen:** Wenn Sie Freihandeingaben auf Ihren Folien vornehmen, können Sie auf diese Freihandeingaben Replay-Animationen anwenden, um den eigentlichen Zeichenvorgang während der Bildschirmpräsentation wiederzugeben. [Weitere Informationen](https://support.office.com/article/fa4f044f-810b-43fe-b774-da04a0b37496)<br />Weitere Detailinformationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2019/07/02/be-more-expressive-in-your-presentations-by-using-ink-replay-in-powerpoint/)

- **Eine sicherere Video-Umgebung:** Sicherheitsverbesserungen bedeuten für Sie eine sicherere Online-Videoumgebung.
...
- **Erstellen von barrierefreien PDF-Dateien:** Erstellen Sie eine PDF-Datei, und die Barrierefreiheitsprüfung weist auf Barrierefreiheitsprobleme hin, die vor dem Speichern behoben werden sollten.<br />Weitere Informationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2019/08/13/accessible-pdfs-made-easier/)
...
- **Optimieren Sie Ihre Präsentation für alle:** Die Barrierefreiheitsprüfung hilft Ihnen beim Anordnen von Objekten auf Ihren Folien, indem sie die Sprachausgabe berücksichtigt.<br />Weitere Informationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2019/10/15/reach-more-people-by-making-your-powerpoint-slides-work-with-a-screen-reader/)
...
- **Weitere Symbole für Ihre Stimmung:** Wir haben über 300 neue Icons hinzugefügt. Sie finden diese unter "Einfügen" > "Symbole". [Weitere Informationen](https://support.office.com/article/3b179567-785e-42ac-8544-ec4ee5ebf1c8)<br />Weitere Detailinformationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2019/04/24/your-feedback-in-action-new-insertable-icons/)
...
- **Zeichnen Sie es auf:** Verleihen Sie Office-Shapes in Ihrem Dokument ein ungezwungenes, von Hand gezeichnetes Aussehen. [Weitere Informationen](https://support.office.com/article/ec2e4491-d3bf-4266-beac-f6298fdfde9f)<br />Weitere Detailinformationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2019/07/03/sketchy-shapes-for-word-powerpoint-and-excel/)
...
- Das Öffnen einer Arbeitsmappe mit Verweisen auf zahlreiche andere Arbeitsmappen, insbesondere mit ausgeblendeten Fenstern, würde langsamer als erwartet ablaufen.
...
- Es wurde ein Problem behoben, bei dem die Eigenschaft "Wert wird überschnitten bei" auf der Diagrammachse unerwartet geändert wird, wenn Sie eine Datei speichern und erneut öffnen.
...
- Das Einfügen einer Spalte in eine gefilterte Liste dauert länger als erwartet.
...
- Verwendung von „Application.Evaluate“ von VBA funktionierte in einigen Fällen für benutzerdefinierte Funktionen nicht.
...
- Die Verwendung von Range.Value und Range.Value2 (VBA) führt dazu, dass Formeln als dynamische Arrays eingegeben werden.
...
- Verbesserte Synchronisierungs- und Dienststabilität durch vorübergehende Reduzierung der maximal zulässigen Größe neuer eingebetteter Anhänge auf 50 MB in OneNote 2016. Bei Dateien, die dieses Limit überschreiten, haben Benutzer die Möglichkeit, die Datei auf OneDrive hochzuladen und einen Link in OneNote einzufügen.

- Verbesserte Synchronisierungs- und Dienststabilität durch vorübergehende Deaktivierung der Videoaufzeichnung in der Anwendung in OneNote 2016. Lokale Notizbücher sind von dieser Maßnahme nicht betroffen.
...
- Behebt ein Problem, das dazu führte, dass Benutzer gelegentlich Abstürze in Outlook erfahren haben.
...
- Behebt ein Problem, das bewirkte, dass bei einer bevorstehenden Änderung der Zeitzonendefinition Terminserien oder Besprechungen zur falschen Uhrzeit angezeigt wurden.

- Wenn Sie die Zeitzone für Brasilien im Jahr 2019 verwenden, werden Besprechungsserien und Termine in der falschen Zeitspanne für das Jahr 2020 angezeigt. Diese Änderung ist für Kunden relevant, die sich in der Zeitzone von Brasilien befinden oder Besprechungen und Termine gebucht haben, die in dieser Zeitzone stattfinden.<br><br>Mit dieser Änderung kann Outlook bestimmte Zeitzoneneinstellungen außer Kraft setzen, die von Outlook verwendet werden. Um eine Zeitzonenaußerkraftsetzung aufzurufen, müssen Sie einen Registrierungsschlüssel für den aktuellen Benutzer festlegen. Der Name des Registrierungsschlüssels muss mit dem internen Namen der Zeitzone übereinstimmen. Der Wert gibt das Jahr der Zeitzonenregel an, die anstelle des aktuellen Jahres verwendet werden soll. Der folgende Registrierungsschlüssel-Außerkraftsetzungswert verwendet z. B. die Brasilia-Zeitzone für das Jahr 2020 als aktuelle Regel. HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Outlook\TimeZoneOverride]"E. South America Standard Time"=dword:000007e4.

- Behebt ein Problem, das bewirkt hat, dass die Benutzer sahen, wie sich das Feld "Ort" in Besprechungen unerwartet ändert.

- Behebt ein Problem, durch das das Feld "Ort" in Besprechungen unerwartet aktualisiert wurde.
...
- Behebt ein Problem, das bei Benutzern mit Postfächern auf Exchange 2010-Servern zu Problemen beim Hinzufügen von Anlagen zu Kalendereinträgen führte.

- Behebt ein Problem, durch das Benutzer Probleme beim Beantworten digital signierter Nachrichten hatten.

- Behebt ein Problem, durch das Benutzer einige Instanzen von wiederkehrenden Kalenderelementen nicht öffnen konnten.

- Behebt ein Problem, das dazu führte, dass die Kopfzeile einer Gruppe in einigen Szenarios unerwartet erweitert wurde.
...
- Behebt ein Problem, durch das Benutzer mit einer spürbaren Verzögerung beim Interagieren mit ihren Postfachordnern über Tastenkombinationen konfrontiert waren.
...
- Behebt ein Problem, das einen Speicherverlust bei sehr langen Outlook-Sitzungen verursachte.

- Behebt ein Problem, durch das Nutzer beim Angeben einer ungültigen Absenderadresse einen Absturz verursacht hat.

- Behebt ein Problem, durch das Benutzern eine beim Öffnen des Dialogfelds "Regeln" die folgende Meldung "Die Regeln auf diesem Computer stimmen nicht mit den Regeln in Microsoft Exchange überein" angezeigt wurde.

- Behebt ein Problem, durch das die Option zum Deaktivieren der Hervorhebung markierter Elemente in einigen Szenarien nicht berücksichtigt wurde.

- Behebt ein Problem, durch das beim Drücken der Taste „S“ nach dem Schließen der Barrierefreiheitsprüfung unerwartet E-Mails gesendet wurden.
...
- Behebt ein Problem, das während der Profilerstellung ein Absturz verursachte.

- Behebt ein Problem, das bewirkt hat, dass Benutzer ein leeres Meldungsfeld mit einer "OK"-Schaltfläche angezeigt bekamen, wenn Sie versuchten, den Support über den Kontext der Kontoerstellung zu kontaktieren.
...
- Behebt ein Problem, aufgrund dessen Outlook-Benutzern auf Serverbetriebssystemen die Fehlermeldung "Antivirenstatus: Ungültig" angezeigt wurde. Diese Version von Windows unterstützt die Erkennung von Antivirus, aber es wurde kein Antivirus gefunden, obwohl Antivirus korrekt konfiguriert war.
...
- Behebt ein Problem, aufgrund dessen Benutzer mit der falschen Browseremulationseinstellung nicht die Authentifizierungsaufforderung für Gmail ausführen konnten.
...
- Behebt ein Problem, das bewirkt, dass Benutzer beim Öffnen von .msg- und .oft-Dateien nach einem Windows-Update einen Absturz erfahren.

- Behebt ein Problem, das gelegentlich zu einem Absturz führte, wenn Benutzer den X-Knopf ihrer Maus verwendeten.

- Behebt ein Problem, bei dem es zu einem Absturz kam, wenn Benutzer bestimmte Suchergebnisse ausgewählt haben.
...
- Behebt ein Problem, durch das Benutzer einen Absturz erfahren, wenn zwei Add-Ins der gleichen Menübandgruppe eine Schaltfläche hinzufügen.

- Behebt ein Problem, das bewirkt, dass Links nicht zu E-Mails mit der richtigen standardmäßigen Mandantenberechtigung hinzugefügt werden können, wenn die standardmäßige Mandantenberechtigung als "jeder" konfiguriert ist.

- Behebt ein Problem, aufgrund dessen Benutzer nicht in der Lage waren, E-Mails an eine persönliche Verteilerliste zu senden.
...
- Behebt ein Problem, das bewirkt hatte, dass der Text einer NDR-Nachricht nach der Bearbeitung des Betreffs von Unicode in ASCII geändert wurde.

- Behebt ein Problem, durch das Benutzer einen Speicherverlust im Outlook-Prozess beobachten konnten.

- Behebt ein Problem, durch das Benutzern unter bestimmten Umständen E-Mails angezeigt werden, die an eine Adresse gesendet wurden, die nicht mit der angezeigten SMTP-Adresse übereinstimmt.

- Behebt ein Problem, das dazu führte, dass das Suchfeld im Modus mit hohem DPI-Wert nicht korrekt ausgerichtet war.

- Behebt ein Problem, das dazu führte, dass Benutzer in Outlook beim Abrufen von Cloudeinstellungen hängen bleiben.

- Behebt ein Problem, durch das die Such-Feedback-Umgebung zum Hängen gebracht wurde.
...
- Behebt ein Problem mit der Weiterleitung von korrekten Nachrichten für Benutzer, die eine Kopie einer Datei mit verbesserten Kommentaren öffnen.
...
- Wir haben ein Problem erkannt, bei dem Benutzer beim Öffnen eines schreibgeschützten Projekts mehrere Nachrichten erhalten könnten
...
- Es wurde ein Problem behoben, aufgrund dessen es beim Hinzufügen oder Entfernen von Apps in einer einzigen Transaktion zu einer unvollständigen Entfernung kam.
...
- Behebt ein Problem, bei dem Office-Aktualisierungen möglicherweise unerwartet Dateien aus dem Office CDN anstelle der beabsichtigten Quelle heruntergeladen haben, beispielsweise eine lokale oder Netzwerkfreigabe oder einen vom Configuration Manager bereitgestellten Speicherort.
...
- Unser Team hat Clientunterstützung für die Berichterstellungstelemetrie in den Office CDN-Domänen im halbjährlichen Enterprise Preview hinzugefügt.
...
- Der Office-Host wurde in Fenstern geschlossen, wenn ein Add-In aktiviert wird, während der Registrierungsschlüssel HKEY_CURRENT_USER\Software\Microsoft\Internet Explorer\Main\TabProcGrowth auf Null festgelegt ist. Mit dieser Änderung wird dieses Problem behoben.
...
## <a name="version-1908-july-14"></a>Version 1908: 14. Juli
...
- Es wurde ein Problem behoben, durch das Punkt-Linien-Diagramme beim Ändern der Reihensammlung nicht ordnungsgemäß dargestellt werden konnten.
...
- Beim Kopieren von nach Farbe gefilterten Daten in eine Spalte mit einer anderen Breite wurden die Werte nicht eingefügt.
...
- Behebt ein Problem, das bewirkt hat, dass die URL für den einfachen Mauszeiger bei einigen Safelinks nicht angezeigt wird.
...
- Behebt ein Problem, durch das Benutzern beim Kopieren von Elementen aus Ihrem primären Kalender in einen Gruppenkalender ein Berechtigungsfehler angezeigt wird.

- Behebt ein Problem, bei dem Benutzer nicht in der Lage waren, über eine Sprachausgabe auf Standortvorschläge zuzugreifen.
...
- Behebt ein Problem, das bei der Interaktion mit bestimmten Safelinks in Outlook zu einem Absturz führte.
...
- Behebt ein Problem, das bei der Verarbeitung von Antworten der AutoErmittlung zu einem Absturz führte.
...
- Behebt ein Problem, durch das Benutzern Fehler beim Durchsuchen moderner Gruppen angezeigt wurden.

- Behebt ein Problem, das dazu führte, dass Outlook-Benutzer in bestimmten Szenarien im Zustand " Kennwort erforderlich " stecken geblieben sind.

- Behebt ein Problem, bei dem Benutzer bei der Verarbeitung von Konfliktnachrichten Synchronisierungsfehler hatten.

- Behebt ein Problem, das dazu führte, dass Benutzer beim Öffnen von MSG- und OFT-Dateien nach der Anwendung eines kürzlich durchgeführten Windows-Updates einen Absturz erlebten.

- Behebt ein Problem, bei dem Benutzer beim Starten von Outlook beim Laden des Profils auf dem Bildschirm "Laden von Profilen" hängen blieben.
...
- Behebt ein Problem, bei dem es durch das Herunterfahren von Outlook zu einem Absturz kam.

- Behebt ein Problem, durch das Kunden in einigen Szenarios eine leere Raumliste zu sehen bekamen.

- Behebt ein Problem, durch das Benutzer beim Ändern von Ansichten zeitweise Abstürze sehen konnten.
...
- Behebt ein Problem, bei dem Benutzer Raumvorschläge für Besprechungen, die außerhalb der Verfügbarkeitszeiten dieses Raums stattfanden, einsehen konnten.
...
- Behebt ein Problem, das einen Absturz verursachte, wenn Benutzer versuchten, aus einer "Verpasste Unterhaltung"-Nachricht heraus eine Regel zu erstellen.

- Behebung eines Problems, durch das bei einigen Benutzern beim Hinzufügen eines sekundären Exchange-Kontos doppelte Sonderordner angezeigt wurden.

- Behebt ein Problem, das dazu führte, dass Benutzer beim Weiterleiten großer HTML-Nachrichten den Nachrichtentext abgeschnitten sahen.

- Behebt ein Problem, durch das Benutzer einen Speicherverlust im Outlook-Prozess beobachten konnten.

- Behebt ein Problem, das zu sporadischen Abstürzen führte, wenn Benutzer ihre Anwesenheitsinformationen aktualisierten.

- Behebt ein Problem, das bewirkt, dass die aktuelle Ordnersuche zweitweise fehlschlägt.

- Behebt ein Problem, bei dem einige Benutzer beim Versuch, ihre Cloud-Einstellungen für Outlook abzurufen, auf Authentifizierungsfehler stießen.
...
- Es wurde ein Problem behoben, durch das verhindert wurde, dass einige Animationen gestartet werden.

- Ein Problem wurde behoben, durch das beim Kopieren einer Folie aus einer Präsentation in eine andere möglicherweise doppelte Master erstellt wurden.<br>
...
- Es wurde ein Problem behoben, das zu Skalierungsproblemen führte, wenn auf Deskjet-Druckern gedruckt wurde
...
- Behebt verschiedene Probleme, bei denen die App beim Herunterfahren hängen bleiben kann. Außerdem wurden Absturzursachen im Zusammenhang mit bestimmten Add-Ins behoben.
...
- Behebt einen Absturz in Word, indem es von einer veralteten API entfernt wurde.

- Behebt ein Problem, bei dem Katakana-Zeichen mit halber Breite in vertikalen Textfeldern in PowerPoint nicht ordnungsgemäß gedreht wurden.
...
- Behebt ein Problem, bei dem Updates in getakteten Netzwerken möglicherweise unerwartet blockiert wurden.
...
- Behebt ein Problem, bei dem ein Update in bestimmten Fällen nicht installiert wurde, wenn der Benutzer kein Administrator ist und das Systemkonto keine Netzwerkverbindung hatte.
...
- Behebt Probleme im Zusammenhang mit der Anpassung der Eigenschaft "TextBox/ Form automatisch anpassen" in Drittanbieter-Plug-ins.
...
- Es wurde ein Problem behoben, bei dem große Strukturansichten zu einem Absturz führten.
...
## <a name="version-1902-july-14"></a>Version 1902: 14. Juli
...
- Es wurde ein Problem behoben, das zu einem Absturz führte, wenn Benutzer MSG- und OFT-Dateien nach dem Anwenden eines kürzlich durchgeführten Windows-Updates öffneten.
