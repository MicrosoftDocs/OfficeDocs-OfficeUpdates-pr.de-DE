...
- **Sie suchen nach Konferenzräumen mit bestimmten Eigenschaften, die für Ihre Besprechung benötigt werden:** Filtern Sie in den Feldern „Kapazität“, „Ausstattung“ und „Etage“ nach Räumen auf Basis Ihrer Gruppengröße, der gewünschten Ausstattung und der Etage, in der sich der Raum befindet.
...
- **Suchen Sie nach etwas in natürlicher Sprache:** Verwenden Sie alltägliche Sätze wie "Tierarzttermin letzte Woche", um die Suchergebnisse zu filtern und einzuschränken. [Weitere Informationen](https://support.office.com/article/0c819cb0-980c-47c3-8e67-5c4fec6b6b87)
...
- **Alle Ihre Zeichentools an einem Ort:** Die Stifte-Toolbox der Registerkarte „Zeichnen“ wurde durch Hinzufügen von Lasso und Radierer aktualisiert, sodass nun alle Tools, die Sie mit Freihandeingaben verwenden, zusammen verfügbar sind.<br />Weitere Detailinformationen finden Sie unter [Blogbeitrag](https://blog-insider.office.com/2020/04/10/meet-the-new-action-pen/)
...
- **Lasso und Radierer in der Freihand-Toolbox:** Wenn Sie die Zeichentools verwenden, sind Lasso und Radierer jetzt in der Freihand-Toolbox verfügbar. [Weitere Informationen](https://support.office.com/article/7edbcf8e-0004-484d-9b62-501a31c23ee9)<br />Weitere Detailinformationen finden Sie im [Blogbeitrag](https://blog-insider.office.com/2020/04/10/meet-the-new-action-pen/)
...
- Ein Problem wurde behoben, durch das die Anzeigefunktion von DialogSheets in 32-Bit-Versionen von Excel nicht funktionierte.
...
- Es wurde ein Problem behoben, das bei Benutzern mit freigegebenen oder delegierten Postfächern mit großen Hierarchien in ihrem Profil dazu führte, dass das System nicht mehr reagierte.
...
- Ein Problem wurde behoben, das dazu führte, dass den Benutzern neu hinzugefügte Kalender im Navigationsbereich als deaktiviert angezeigt wurden, bis ein Neustart von Outlook ausgeführt wurde.
...
- Es wurde ein Problem behoben, das bei einigen Kunden dazu führte, dass das System beim Laden ihrer Kalender nicht mehr reagierte.
...
- Es wurde ein Problem behoben, durch das Outlook im Leerlauf unerwartet geschlossen wurde.
...
- Es wurde ein Problem behoben, das dazu führte, dass das System unerwartet geschlossen wurde, wenn Benutzer die Einstellungen unter "Cloudeinstellungen" aktualisierten.
...
- Es wurde ein Registrierungsschlüssel hinzugefügt, mit dem Kunden die Einbeziehung der Dateizeit für Anhänge in IDataObject-Operationen (d. h. Drag & Drop, Zwischenablage) deaktivieren können.  
...
- Es wurde ein Registrierungsschlüssel hinzugefügt, mit dem die neue Benutzeroberfläche der Raumsuche (dieselbe Benutzeroberfläche wie in Outlook für Web) deaktiviert und die Vorgängerversion der Raumsuche mit „Vorgeschlagene Zeiten“ aktiviert wird. Registrierungsschlüssel:
...
- Es wurde ein Problem behoben, bei dem bestimmte Benutzer PowerPoint-Präsentationen keine Forms-Erweiterung hinzufügen konnten.
...
- Ein Problem mit auf Symbole und SVG-Grafiken mit 3D-Effekten angewendeten Farben wurde behoben.
...
- Ein Problem in Wordmail wurde behoben, bei dem ein Benutzer dieses Element nicht senden kann, wenn das 2084. Zeichen in einem Link ein Escapezeichen ist.
...
- Ein Problem wurde behoben, bei dem eine Datei nicht umbenannt werden konnte, wenn eine SyncBacked-Datei offline geöffnet wurde.


- Ein Problem wurde behoben, das im Falle eines Rollbacks zu einem vorherigen Build bei Word, PowerPoint und Excel dazu führen konnte, dass das Öffnen eines Cloud-Dokuments fehlschlug.
...
## <a name="version-2008-july-13"></a>Version 2008: 13. Juli
...
## <a name="version-2002-july-13"></a>Version 2002: 13. Juli
...
- Der Office-Host wurde in Windows unerwartet geschlossen, wenn ein Add-In aktiviert wurde, während der Registrierungsschlüssel „HKEY_CURRENT_USER\Software\Microsoft\Internet Explorer\Main\TabProcGrowth“ auf Null gesetzt war. Diese Änderung würde das Problem beheben.
